...
//GLOBAL
$left_loc 	  = "daily_balance_demo_by_reference.php";
...
<table width="100%" class="table_box">
	<tr>
		<td align="right">
			<a href="./daily_balance_demo_by_item.php?<?php echo getQueryString()?>">View By Item</a>
		</td>
	</tr>
</table>
<?php require_once APP_DIR . "_include/request_demo/report/rpt_daily_balance_demo_by_reference.php" ?>
