...
//GLOBAL
$left_loc	  = "summary_delivery_by_customer.php";
...
<table width="100%" class="table_layout">
	<tr>
		<td width="90%" rowspan="2"><h3>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] SUMMARY DELIVERY ORDER by customer</h3></td>
...
<table width="100%" class="table_layout">
	...
	<tr>
		<td><input type="text" name="_cus_code" size="10" class="fmt" onClick="fillCustomer('')" value="<?php echo $_cus_code?>" readonly></td>
        <td>
...
<?php require_once APP_DIR . "_include/order/report/rpt_summary_delivery_detail_by_customer.php" ?>
...
?>
	...
	f.cboFilterPaper.onchange	= f.cboSortBy.onchange;
	f.cboFilterOrderBy.onchange	= f.cboSortBy.onchange;
