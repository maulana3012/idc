...
//GLOBAL
$left_loc = "summary_monthly_item_by_ed.php";
...
<iframe id="rightFrame" src="i_summary_monthly_item_by_ed.php?<?php echo getQueryString()?>" frameborder="0" width="100%" height="2000px" name="iFrm"></iframe><br /><br />
