...
<table width="100%" class="table_layout">
	<tr>
		<td width="85%" rowspan="2"><strong class="title">[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] ED SUMMARY by item<br /><br /></strong></td>
		<td> ORDER BY </td>
		<td> SOURCE </td>
        <td> CATEGORY </td>
	</tr>
...
<table width="100%" class="table_box">
	<tr>
		<td align="right">
			<a href="./daily_ed_by_group.php?<?php echo getQueryString()?>">View By Group</a>
		</td>
	</tr>
</table>
<?php require_once APP_DIR . "_include/warehouse/report/summary/rpt_daily_ed_detail_by_item.php" ?>
