...
//GLOBAL
$left_loc = "daily_summary_by_item.php";
...
if(isset($_GET['lastCategoryNo']) && $_GET['lastCategoryNo'] > 0) {
	...
	if(isZKError($path = executeSP(ZKP_SQL."_getCategoryPath", $_last_category))) {
		$M->goErrorPage($path, HTTP_DIR . "warehouse/warehouse/index.php");
	} else {
  ...
  <tr>
    <td style="padding:0 3 3 3">
        ...
        <tr>
          	...
          	<!--START: BODY-->
			<h4>SUMMARY WAREHOUSE by item</h4>
<?php
...
if($s_mode == 'period') {
	$some_date 		= "";
	$period_from 	= isset($_GET['period_from'])? $_GET['period_from'] : "";	//date("j-M-Y", time()-86400
...
<table width="100%" class="table_layout">
	...
	<tr>
		<td colspan="7" align="right"><small class="comment"><i>* Total = Issue Item + Order</i></small></td>
	</tr>
</table>
</form><br />
<?php require_once APP_DIR . "_include/warehouse/report/warehouse/rpt_daily_summary_by_item.php" ?>
...
?>
	...
	f.cboFilterDoc.onchange = f.cboOrderBy.onchange;
