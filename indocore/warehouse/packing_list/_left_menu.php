...
$cat = array("PL Balance", "Outstanding PL", "Arrival PL");
//------------------------------------------------------------------
...
//------------------------------------------------------------------
$item0[] = "summary_pl_by_item.php::By Item";
$item0[] = "summary_pl_by_supplier.php::By Supplier";

$item1[] = "summary_outstanding_by_item.php::By Item";
$item1[] = "summary_outstanding_by_supplier.php::By Supplier";

$item2[] = "summary_arrival_by_item.php::By Item";
$item2[] = "summary_arrival_by_supplier.php::By Supplier";
//------------------------------------------------------------------
