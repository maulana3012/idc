...
?>
<h3>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] PL SUMMARY by supplier</h3>
<div align="right">
...
<tr>
	<td align="right">
		<a href="<?php echo HTTP_DIR . "$currentDept/$moduleDept/" ?>summary_pl_by_item.php?<?php echo getQueryString()?>">View By Item</a>
	</td>
</tr>
</table>
<?php require_once APP_DIR . "_include/warehouse/report/purchasing/rpt_summary_pl_by_supplier.php" ?>
