...
?>
<h3>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] PO LOCAL BALANCE by supplier</h3>
<div align="right">
...
<?php require_once APP_DIR . "_include/warehouse/report/purchasing/rpt_summary_po_balance_by_supplier.php" ?>
...
?>
	...
	f.cboStatus.onchange = f.cboType.onchange;
