...
$strGet		= $findStrGet . "&cboLocation=$_location";
...
<script language="javascript" type="text/javascript">
	function searchByCat() {
		...
		for (var i = 2; i >=0; i--) {
			if (o[i].value != 0) {
				window.location.href = "?lastCategoryNo=" + o[i].value + '&cboLocation='+loc;
				break;
			}
		}
	}
	...
	window.document.all.cboLocation.onchange = function() {
		var loc		= window.document.all.cboLocation.value;
		window.location.href = './list_detail_item.php?<?php echo getQueryString() ?>&cboLocation='+loc;
	}
</script>
...
<table width="100%" class="table_f">
	<tr height="18px">
		...
		<th rowspan="2" style="background-color:#9CBECC"></th>
		<th colspan="8">WAREHOUSE CONFIRM</th>
		<th rowspan="2" style="background-color:#9CBECC"></th>
