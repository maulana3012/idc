...
<input type="hidden" name="_idx_reject" value="<?php echo $wh[1] ?>">
...
for($i=0; $i<$wh[1]; $i++) {
	$v = (1==intval($wh[0][$i][0]))?' checked':'';
	echo "\t\t\t<input type=\"radio\" name=\"_loc\" value=\"".$wh[0][$i][0]."\" id=\"".$wh[0][$i][1]."\"".$v."><label for=\"".$wh[0][$i][1]."\"> ".$wh[0][$i][1]." </label>\n";
}
?>
		</td>
	</tr>
