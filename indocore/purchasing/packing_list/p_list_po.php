...
$sqlQuery->setOrderBy("po_code, po_date");
...
?>
	  <tr>
		...
		<td width="18%"><a href="javascript:fillField('<?php echo $column['po_code']?>')"><b><?php echo $column['po_code']?></b></a></td>
		<td width="22%"><?php echo date('j-M-Y', strtotime($column['po_date']))?></td>
