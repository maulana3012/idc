...
//$_status	= isset($_REQUEST['_status'])? $_REQUEST['_status'] : $_REQUEST['_status'] = "P";
$strGet	= "";
...
function fillItem(idx) {
	...
	f._plit_item.value	= it[idx][2];
	f._plit_desc.value	= it[idx][3];
	f._plit_att.focus();
...
function createNewItem() {
	...
	if (f._it_code.value.length <= 0) {
		...
		f.it_code.focus();
		return;
	} else if(f._plit_qty.value == 0) {
		alert("please input qty");
		f._plit_qty.focus();
		return;
	} else if(isNaN(removecomma(f._plit_qty.value))) {
	...
	f._plit_att.value			= f._plit_att.value;
	f._plit_qty.value			= removecomma(f._plit_qty.value);
	f._plit_remark.value		= f._plit_remark.value;
	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<input type="text" name="_plit_item" style="width:100%" class="fmt">
			</td>
			<td><input type="text" name="_plit_desc" style="width:100%" class="fmt"></td>
			<td><input type="text" name="_plit_att" style="width:100%" class="fmt"></td>
			<td><input type="text" name="_plit_qty" style="width:100%" class="reqn" onKeyUp="formatNumber(this, 'dot');" onKeyPress="if(window.event.keyCode == 13) createNewItem()"></td>
			<td><input type="text" name="_plit_remark" class="fmt" style="width:100%" onKeyPress="if(window.event.keyCode == 13) createNewItem()"></td>
		</tr>
		<tr>
		<td colspan="7" align="right"><button class="input_sky" onClick="createNewItem()" accesskey="a">ADD</button>&nbsp;<button onClick="window.close();" class="input_sky">CLOSE</button></td>
		</tr>
	</tbody>
</table>
</form>
