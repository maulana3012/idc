...
//RECEIVE DATA FROM input_po_step_1.php
if(ckperm(ZKP_INSERT, HTTP_DIR . "$currentDept/$moduleDept/input_invoice_step_1.php", 'order_info')) {
...
//---------------------------------------------------------------------------------------------------- insert PL
if(ckperm(ZKP_INSERT, HTTP_DIR . "/index.php", 'insert')) {
