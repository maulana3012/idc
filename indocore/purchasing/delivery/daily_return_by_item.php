...
<table width="100%" class="table_layout">
	<tr>
		<td rowspan="2" width="80%" valign="top"><strong class="title">[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] RETURN SUMMARY by item</strong></td>
		<td>PUSAT</td>
		<td>DEPT</td>
	</tr>
	<tr>
...
<?php require_once APP_DIR . "_include/purchasing/report/delivery/rpt_daily_return_by_item.php" ?>
