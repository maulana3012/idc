...
?>
<h4>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] PO SUMMARY by supplier</h4>
<div align="right">
...
<table width="100%" class="table_box">
	<tr>
		<td align="right">
			<a href="<?php echo HTTP_DIR . "$currentDept/$moduleDept/" ?>summary_po_by_item.php?<?php echo getQueryString()?>">View By Item</a>
		</td>
	</tr>
</table>
<?php require_once APP_DIR . "_include/purchasing/report/purchasing/rpt_summary_po_by_supplier.php" ?>
