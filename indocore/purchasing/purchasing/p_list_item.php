...
function createNewItem() {
	...
	if (f._it_code.value.length <= 0) {
		...
		f.it_code.focus();
		return;
	} else if(f._poit_unit_price.value == 0) {
	...
	f._poit_att.value			= f._poit_att.value;
	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<input type="text" name="_poit_item" style="width:100%" class="fmt">
			</td>
			<td><input type="text" name="_poit_desc" style="width:100%" class="fmt" readonly></td>
			<td><input type="text" name="_poit_att" style="width:100%" class="fmt"></td>
