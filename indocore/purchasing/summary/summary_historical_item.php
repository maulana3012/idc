...
//GLOBAL
$left_loc = "summary_historical_item.php";
...
$_vat			= isset($_GET['cboFilterVat']) ? $_GET['cboFilterVat'] : "vat";
...
?>
<h3>[<font color="#446fbe">GENERAL</font>] Report Taxable Stock</h3>
...
<?php require_once APP_DIR . "_include/purchasing/report/summary/rpt_summary_historical_item.php" ?>
<script language="javascript1.2" type="text/javascript">
	...
	setSelect(f.cboFilterVat, "<?php echo isset($_GET['cboFilterVat']) ? $_GET['cboFilterVat'] : "vat"?>");
