...
$_method		= isset($_GET['cboFilterMethod']) ? $_GET['cboFilterMethod'] : "all";
...
<table width="100%" class="table_layout">
	<tr>
		<td width="80%" rowspan="2"><h3>[<font color="#446fbe">GENERAL</font>] PAYMENT SUMMARY by group </h3></td>
		<td> ORDER BY </td>
		<td> MARKETING </td>
	</tr>
	<tr>
...
?>
		...
		<td>
			<select name="cboFilterMethod">
				<option value="all">=ALL=</option>
				<option value="0">CASH</option>
				<option value="1">CHK</option>
				<option value="2">GIRO</option>
				<option value="3">T/S</option>
				<option value="4">DNM</option>
				<option value="5">BCA1</option>
				<option value="6">BCA2</option>
				<option value="7">MNDRI</option>
				<option value="8">BII1</option>
				<option value="9">BII2</option>
			</select>
		</td>
		<td valign="middle">
...
<?php require_once APP_DIR . "_include/purchasing/report/summary/rpt_payment_by_group.php" ?>
<script language="javascript1.2" type="text/javascript">
	...
	setSelect(f.cboFilterMethod, "<?php echo isset($_GET['cboFilterMethod']) ? $_GET['cboFilterMethod'] : "all"?>");
	...
	f.cboFilterMethod.onchange		= f._cug_code.onchange;
