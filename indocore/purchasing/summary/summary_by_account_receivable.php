...
//GLOBAL
$left_loc = "summary_by_account_receivable.php";
?>
<html>
<head>
...
<table width="100%" class="table_layout">
	<tr>
		<td width="80%" rowspan="2"><h3>[<font color="#446fbe">GENERAL</font>] SUMMARY PAYMENT by department</h3></td>
		<td> ORDER BY </td>
		<td> MARKETING </td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			<select name="cboFilterDept">
				...
				<option value="S">CUSTOMER SERVICE</option>
			</select>
		</td>
		<td valign="middle">
...
<?php require_once APP_DIR . "_include/purchasing/report/summary/rpt_summary_by_account_receivable.php" ?>
