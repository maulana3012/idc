...
//DEFAULT PROCESS
$sqlQuery = new strSelect("SELECT it_code, it_model_no, it_type, it_desc, it_ed FROM ".ZKP_SQL."_tb_item");
...
<small>* Printed for set initial indocore stock</small>
</strong>
<hr>
...
<table width="100%" class="table_box">
	<tbody>
		...
		<tr>
			...
			<td>
				<input type="text" name="_it_qty" style="width:100%" class="reqn" onKeyUp="formatNumber(this, 'dot');" onKeyPress="if(window.event.keyCode == 13) createNewItem()">
				<input type="hidden" name="_it_ed" style="width:100%">
			</td>
		</tr>
		<tr>
