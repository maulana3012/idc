...
//Global
$left_loc 	= "list_remove_by_date.php";
?>
<html>
<head>
...
?>
<h4>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] MOVE STOCK LOCATION SUMMARY by item</h4>
...
<table width="100%" class="table_box">
	<tr>
		<td align="right">
			<a href="./list_remove_by_item.php?<?php echo getQueryString()?>">View By Item</a>
		</td>
	</tr>
</table>
<?php require_once APP_DIR . "_include/purchasing/report/setup_stock/rpt_list_remove_by_date.php" ?>
