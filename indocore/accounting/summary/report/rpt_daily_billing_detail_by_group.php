...
$sql_dr .= "
  ...
  CASE
	WHEN b.dr_dept = 'A' THEN '../../apotik/other/revise_dr.php?_code='||dr_code
	WHEN b.dr_dept = 'D' THEN '../../dealer/other/revise_dr.php?_code='||dr_code
	WHEN b.dr_dept = 'H' THEN '../../hospital/other/revise_dr.php?_code='||dr_code
	WHEN b.dr_dept = 'P' THEN '../../pharmaceutical/other/revise_dr.php?_code='||dr_code
  END AS go_page
FROM
 ".ZKP_SQL."_tb_customer AS c
...
END;
	...
	foreach($group1 as $total2 => $group2) {
		...
		foreach($group2 as $total3 => $group3) {
			...
			cell(number_format($rd[$rdIdx][8]),' style="'. $display_css[$rd[$rdIdx][22]] .'" valign="top" align="right" rowspan="'.$rowSpan.'"'); 			//Freight charge
			...
			foreach($group3 as $group4) {
				...
				cell(number_format($rd[$rdIdx][13]), ' style="'.$display_css[$rd[$rdIdx][22]].'" align="right"');	//Unit price
				cell(number_format($rd[$rdIdx][14]), ' style="'.$display_css[$rd[$rdIdx][21]].'" align="right"');	//Qty
				cell(number_format($rd[$rdIdx][15]), ' style="'.$display_css[$rd[$rdIdx][22]].'" align="right"'); 	//Amount
				cell(number_format($rd[$rdIdx][16]), ' style="'.$display_css[$rd[$rdIdx][22]].'" align="right"');	//Vat
				cell(number_format($rd[$rdIdx][17]), ' style="'.$display_css[$rd[$rdIdx][22]].'" align="right"');	//Amount + vat
			...
			cell(number_format($inv_total[1]), ' style="'.$display_css[$css_qty].'" align="right" style="color:darkblue;"');
			cell(number_format($inv_total[2]), ' style="'.$display_css[$css_amount].'" align="right" style="color:darkblue;"');
			cell(number_format($inv_total[3]), ' style="'.$display_css[$css_amount].'" align="right" style="color:darkblue;"');
			cell(number_format($inv_total[4]), ' style="'.$display_css[$css_amount].'" align="right" style="color:darkblue;"');
			cell(number_format($inv_total[5]), ' style="'.$display_css[$css_amount].'" align="right" style="color:darkblue;"');
			print "</tr>\n";
	...
	cell(number_format($cus_total[0]), ' align="right" style="color:brown; background-color:lightyellow"');
	cell("&nbsp", ' style="background-color:lightyellow" colspan="3"');
	cell(number_format($cus_total[1]), ' align="right" style="color:brown; background-color:lightyellow"');
	cell(number_format($cus_total[2]), ' align="right" style="color:brown; background-color:lightyellow"');
	cell(number_format($cus_total[3]), ' align="right" style="color:brown; background-color:lightyellow"');
	cell(number_format($cus_total[4]), ' align="right" style="color:brown; background-color:lightyellow"');
	cell(number_format($cus_total[5]), ' align="right" style="color:brown; background-color:lightyellow"');
	print "</tr>\n";
	print "</table><br />\n";
...
END;
	...
	cell(number_format($g_total[5]), ' align="right" style="color:brown; background-color:lightyellow"');
	print "</tr>\n";
print "</table>\n";
?>