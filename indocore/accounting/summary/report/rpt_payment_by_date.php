...
END;
	...
	foreach ($month as $week_name => $pay_week) {
		...
		foreach ($pay_week as $billing) {
			...
			cell(number_format($rd[$rdIdx][8]), ' align="right", valign="top" rowspan="'.$rowSpan.'"'); 	//amount
			cell(number_format($rd[$rdIdx][9]), ' align="right", valign="top" rowspan="'.$rowSpan.'"');		// freight
			cell(number_format($rd[$rdIdx][10]), ' align="right", valign="top" rowspan="'.$rowSpan.'"');	//vat
			cell(number_format($rd[$rdIdx][11]), ' align="right", valign="top" rowspan="'.$rowSpan.'"');	//amount +vat+freight
			...
			foreach ($billing as $paid_data) {
				...
				cell(number_format($rd[$rdIdx][16]), ' style="'.$display_css[$rd[$rdIdx][20]].'" align="right"'); //Payment paid
				cell("&nbsp;");								//Invoice remain
			...
			cell("&nbsp");
			cell("&nbsp");
			cell(number_format($invoice[4]), ' align="right" style="color:blue"');	//Payment paid
			cell(number_format($invoice[5]), ' align="right" style="color:blue"');	//Invoice remain
			cell("&nbsp");
		...
		cell("&nbsp;");
		cell("&nbsp;");
		cell(number_format($weekly_summary[4]), ' align="right" style="color:brown"');
		cell(number_format($weekly_summary[5]), ' align="right" style="color:brown"');
		cell("&nbsp");
		cell(number_format($weekly_summary[6]), ' align="right" style="color:brown"');
		print "</tr>\n";
	...
	cell("&nbsp", ' style="color:brown; background-color:lightyellow"');
	cell("&nbsp", ' style="color:brown; background-color:lightyellow"');
	cell(number_format($monthly_summary[4]), ' align="right" style="color:brown; background-color:lightyellow"');
	cell(number_format($monthly_summary[5]), ' align="right" style="color:brown; background-color:lightyellow"');
	cell("&nbsp", ' style="color:brown; background-color:lightyellow"');
	cell(number_format($monthly_summary[6]), ' align="right" style="color:brown; background-color:lightyellow"');
	print "</tr>\n";
	print "</table><br>\n";
