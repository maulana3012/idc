...
$tmp_bill[]		= "bill_vat > 0 AND bill_ship_to = '$_cus_code'";
$tmp_turn[]		= "turn_vat > 0 AND turn_ship_to = '$_cus_code' AND turn_return_condition IN (2,3,4)";
...
END;
	...
	foreach ($pusat as $billing) {
		...
		cell(number_format($rd[$rdIdx][8]), ' style="'.$display_css[$rd[$rdIdx][16]].'" align="right"');	//amount
		cell(number_format($rd[$rdIdx][9]), ' style="'.$display_css[$rd[$rdIdx][16]].'" align="right"');	// freight
		cell(number_format($rd[$rdIdx][10]), ' style="'.$display_css[$rd[$rdIdx][16]].'" align="right"');	//vat
		cell(number_format($rd[$rdIdx][11]), ' style="'.$display_css[$rd[$rdIdx][16]].'" align="right"');	//amount+vat
		cell(number_format($rd[$rdIdx][12]), ' style="'.$display_css[$rd[$rdIdx][16]].'" align="right"');	//amount +vat+freight
		cell(number_format($rd[$rdIdx][13]), ' style="'.$display_css[$rd[$rdIdx][16]].'" align="right"');	//Paid
		cell(number_format($rd[$rdIdx][14]), ' style="'.$display_css[$rd[$rdIdx][16]].'" align="right"');	// Remain
