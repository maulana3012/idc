...
//GLOBAL
$left_loc	= "summary_monthly_by_customer.php";
...
$_filter_ord	= isset($_GET['cboFilterOrder']) ? $_GET['cboFilterOrder'] : $cboFilter[1][ZKP_FUNCTION][0][0];
...
<table width="100%" class="table_layout">
	<tr>
		<td width="80%" rowspan="2">
			<h3>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] SUMMARY MONTHLY by customer</h3>
		</td>
...
<iframe id="rightFrame" src="i_summary_monthly_by_customer.php?<?php echo getQueryString()?>" frameborder="0" width="100%" height="500px" name="iFrm"></iframe><br /><br />
