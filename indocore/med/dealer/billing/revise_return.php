...
$title	= array(1=>"Revise : Issue return invoice &amp; unconfirmed return Item","Issue return invoice only", "Detail : Issue return invoice &amp; confirmed return item");
...
//=================================================================================== DEFAULT PROCESS
if(ZKP_FUNCTION != 'ALL') {
	$tmp[] = ZKP_SQL."_isValidShowInvoice('".ZKP_FUNCTION."', '$_code','billing_return')";
}
$tmp[]	  = "turn_code = '$_code'";
...
if($column['turn_paper']==0) {
	if($column['turn_cfm_wh_delivery_by_account'] != '') {
		$template = 3;
	} else {
		$template = 1;
	}
...
require_once APP_DIR . "_include/billing/tpl_detail_return_item_".$template.".php"; 
