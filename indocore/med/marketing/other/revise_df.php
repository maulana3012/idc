...
if(numQueryRows($result) <= 0) {
	...
	goPage(HTTP_DIR . "$currentDept/$moduleDept/detail_df.php?_code=".urlencode($column['df_code']));
}
...
<script language="javascript" type="text/javascript">
	...
	window.document.all.btnDelete.onclick = function() {
		if(confirm("Are you sure to delete billing?\n Deleting DF will delete booking items too")) {
			oForm.p_mode.value = 'delete_df';
			oForm.submit();
		}
	}
