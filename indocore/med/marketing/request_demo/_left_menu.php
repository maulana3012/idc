...
*/
$cat = array("New Request", "Request Demo", "Return Demo", "Request Balance");
...
$item3[] = "daily_balance_demo_by_item.php::By Item";
$item3[] = "daily_balance_demo_by_reference.php::By Reference";
