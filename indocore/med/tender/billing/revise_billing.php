...
//========================================================================================= DEFAULT PROCESS
//$tmp[]	= ZKP_SQL."_isValidShowInvoice('".ZKP_FUNCTION."', '$_code','billing')";
$tmp[]	= "bill_code = '$_code'";
...
<input type="hidden" name="__payment_chk">
</form>
<!--START Button-->
...
<script language="javascript" type="text/javascript">
	...
	window.document.all.btnUpdate.onclick = function() {
		...
		var pay = 0;
		for (i=4; i<8; i++) {
			if(oForm._payment_chk[i].checked) 
				pay += parseInt(oForm._payment_chk[i].value);
		}
		oForm.__payment_chk.value = pay;
