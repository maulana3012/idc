...
FROM
 ...
 JOIN ".ZKP_SQL."_tb_in_local_item AS init USING(it_code)
...
SELECT
 it_code,
 it_model_no,
 to_char(elc_expired_date,'Mon-YYYY') as expired_date,
 elc_qty
FROM ".ZKP_SQL."_tb_expired_local join ".ZKP_SQL."_tb_item using(it_code) 
WHERE inlc_idx = $_inlc_idx
ORDER BY it_code,elc_expired_date";
$res_ed =& query($sql_ed);
?>
<html>
<head>
