...
FROM
 ...
 JOIN ".ZKP_SQL."_tb_in_pl_item AS init USING(it_code)
...
SELECT
 it_code,
 it_model_no,
 to_char(epl_expired_date,'Mon-YYYY') as expired_date,
 epl_qty
FROM ".ZKP_SQL."_tb_expired_pl join ".ZKP_SQL."_tb_item using(it_code) 
WHERE inpl_idx = $_inpl_idx
ORDER BY it_code,epl_expired_date";
$res_ed =& query($sql_ed);
?>
<html>
<head>
