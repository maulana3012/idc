...
?>
<strong class="title">[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] NON ORDER SUMMARY by group<br /><br /></strong>
...
<table width="100%" class="table_box">
	<tr>
		<td align="right">
			<a href="./daily_dt_summary_by_item.php?<?php echo getQueryString()?>">View By Item</a>
		</td>
	</tr>
</table><br />
<?php require_once APP_DIR . "_include/warehouse/report/delivery/rpt_dt_summary_by_group.php" ?>
