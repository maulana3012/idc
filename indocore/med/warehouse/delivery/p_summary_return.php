...
//DEFAULT PROCESS
$doc_sql = "SELECT inc_doc_ref FROM ".ZKP_SQL."_tb_incoming WHERE inc_idx IN ($_code)";
...
<table class="table_layout" width="100%">
	<tr height="35px">
		<td style="font-size:15px;font-weight:bold">[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] RETURN SUMMARY</td>
	</tr>
	<tr>
		<td><i class="comment"><b>Return No :</b> <?php echo implode(', ', $doc_name);  ?></i></td>
	</tr>
</table><br />
