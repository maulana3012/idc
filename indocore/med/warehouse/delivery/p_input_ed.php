...
//DEFAULT PROCESS
$sqlQuery = new strSelect("SELECT e_expired_date, e_wh_location, ".ZKP_SQL."_getRemainMonth(e_expired_date) AS expired_date, sum(e_qty) AS remain_month FROM ".ZKP_SQL."_tb_expired_stock");
$sqlQuery->whereCaluse = "e_qty>0 AND it_code='$_code' AND e_wh_location=$_loc";
$strGet = "&_code=$_code&_loc=$_loc";
$sqlQuery->setGroupBy("e_expired_date, e_wh_location, expired_date");
