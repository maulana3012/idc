...
//DEFAULT PROCESS
$sqlQuery = new strSelect("SELECT sp_code, sp_full_name, substr(sp_address,0,70) AS sp_address, sp_phone, sp_fax FROM ".ZKP_SQL."_tb_supplier_local");
$sqlQuery->setWhere("%s ILIKE '%s%%'", array("sp_full_name" => "_name"), "AND");
...
<table width="100%" class="table_no_02">
	<tr>
		<td width="70%"><h3>[<font color="blue"><?php echo strtoupper($currentDept) ?></font>] SUPPLIER LIST</h3></td>
		<td>
