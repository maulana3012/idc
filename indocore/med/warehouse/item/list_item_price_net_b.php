...
//GLOBAL
$left_loc = "list_item_price_net_b.php";
$_disc_1 = 0.3;
$_disc_2 = 0.325;
...
SELECT DISTINCT
  ...
  it_model_no,
  it_desc,
  ".ZKP_SQL."_getuserprice(it_code, CURRENT_DATE, 'net', 'dollar') AS ipn_price_dollar,
  ".ZKP_SQL."_getuserprice(it_code, CURRENT_DATE, 'net', 'kurs') AS ipn_price_kurs,
  ".ZKP_SQL."_getuserprice(it_code, CURRENT_DATE, 'net', 'rupiah') AS ipn_price_rupiah
FROM ".ZKP_SQL."_tb_item AS it JOIN ".ZKP_SQL."_tb_item_price_net AS ipn USING (it_code)");
