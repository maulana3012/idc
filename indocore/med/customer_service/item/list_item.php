...
//DEFAULT PROCESS
$sqlQuery = new strSelect("SELECT *, ".ZKP_SQL."_getUserPrice(it_code, CURRENT_DATE) AS user_price FROM ".ZKP_SQL."_tb_item");
...
<table width="100%" class="table_c">
	...
	<tr>
		...
		<td><a href="<?php echo HTTP_DIR . "$currentDept/$moduleDept/" ?>detail_item.php?_code=<?php echo urlencode(html_entity_decode($column['it_code'], ENT_QUOTES));?>"><?php echo $column['it_code']?></a></td>
