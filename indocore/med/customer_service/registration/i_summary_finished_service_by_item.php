...
<body>
<?php include "./report/rpt_summary_finished_service_by_item.php"?>
<span class="comment"><i>
*) S= Service, C = Calibration, RT =Return to customer , RP = Replacement product, RS=Replacement sparepart
</i></span>
</body>
</html>