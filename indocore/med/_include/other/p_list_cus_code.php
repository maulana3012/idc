...
$_cus_channel	= isset($_REQUEST['_cus_channel'])? $_REQUEST['_cus_channel'] : $_REQUEST['_cus_channel'] = $cus_channel[$_REQUEST['_dept']];
...
function fillField(idx) {
	...
	if(target == 'customer') {
		...
		window.opener.document.frmSearch.cboDate.value = '';	
