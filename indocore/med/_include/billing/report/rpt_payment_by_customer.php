...
if ($some_date != "") {
	...
	$tmp21[] = "p.pay_date BETWEEN DATE '$period_from' AND DATE '$period_to'";
}
...
$tmp1[] = "bill_dept = '$department' AND bill_ship_to = '$_cus_code'";
$tmp2[] = "bill_dept = '$department' AND bill_ship_to = '$_cus_code'";
...
UNION
		...
		FROM
		  ...
		  JOIN ".ZKP_SQL."_tb_payment AS p USING(bill_code)
		WHERE $strWhere2
ORDER BY ship_to, bill_inv_date, invoice_code, pay_date";
/*
echo "<pre>";
echo $sql;
echo "</pre>";
...
END;
	...
	foreach ($group1 as $total2 => $group2) {
		...
		cell(number_format((double)$rd[$rdIdx][6]), ' align="right", valign="top" rowspan="'.$rowSpan.'"');  //amount
		cell(number_format((double)$rd[$rdIdx][7]), ' align="right", valign="top" rowspan="'.$rowSpan.'"'); // freight
		cell(number_format((double)$rd[$rdIdx][8]), ' align="right", valign="top" rowspan="'.$rowSpan.'"'); //vat
		cell(number_format((double)$rd[$rdIdx][9]), ' align="right", valign="top" rowspan="'.$rowSpan.'"'); //amount +vat+freight
		...
		foreach ($group2 as $total3) {
			...
			cell(number_format((double)$rd[$rdIdx][14]), ' style="'.$display_css[$rd[$rdIdx][18]].'" align="right"'); 	//Payment paid
		...
		cell(number_format((double)$invoice[0]), ' align="right" style="color:blue"');
		cell(number_format((double)$invoice[1]), ' align="right" style="color:blue"');
		cell(number_format((double)$invoice[2]), ' align="right" style="color:blue"');
		cell(number_format((double)$invoice[3]), ' align="right" style="color:blue"');
		cell("&nbsp");
		cell("&nbsp");
		cell("&nbsp");
		cell(number_format((double)$invoice[4]), ' align="right" style="color:blue"');
		cell(number_format((double)$invoice[5]), ' align="right" style="color:blue"');
		cell("&nbsp");
	...
	cell(number_format((double)$customer_summary[0]), ' align="right" style="color:brown; background-color:lightyellow"');
	cell(number_format((double)$customer_summary[1]), ' align="right" style="color:brown; background-color:lightyellow"');
	cell(number_format((double)$customer_summary[2]), ' align="right" style="color:brown; background-color:lightyellow"');
	cell(number_format((double)$customer_summary[3]), ' align="right" style="color:brown; background-color:lightyellow"');
	cell("&nbsp", ' style="color:brown; background-color:lightyellow"');
	cell("&nbsp", ' style="color:brown; background-color:lightyellow"');
	cell("&nbsp", ' style="color:brown; background-color:lightyellow"');
	cell(number_format((double)$customer_summary[4]), ' align="right" style="color:brown; background-color:lightyellow"');
	cell(number_format((double)$customer_summary[5]), ' align="right" style="color:brown; background-color:lightyellow"');
	cell("&nbsp", ' style="color:brown; background-color:lightyellow"');
	cell(number_format((double)$customer_summary[6]), ' align="right" style="color:brown; background-color:lightyellow"');
	print "</tr>\n";
	print "</table><br>\n";
