...
?>
		<tr id="<?php echo trim($items[0]).'-'.trim($items[1])?>">
			...
			<td><input type="text" class="fmtn" style="width:100%" name="_wh_it_qty[]" value="<?php echo number_format((double)$items[4],2)?>" onBlur="updateAmount()" onKeyUp="formatNumber(this,'dot')" readonly></td>
...
?>
		<tr id="<?php echo trim($items[1])?>">
			<td><input type="hidden" name="_cus_it_code[]" value="<?php echo $items[1]?>"><?php echo $items[1]?></td>
			<td><input type="text" class="fmt" name="_cus_it_model_no[]" value="<?php echo $items[3]?>" style="width:100%" readonly></td>
			<td><input type="text" class="fmt" name="_cus_it_desc[]" value="<?php echo $items[4]?>" style="width:100%" readonly></td>
			<td><input type="text" class="fmtn" name="_cus_it_unit_price[]" value="<?php echo number_format((double)$items[5])?>" style="width:100%" onBlur="updateAmount()" onKeyUp="formatNumber(this,'dot')"></td>
			<td><input type="text" class="fmtn" name="_cus_it_qty[]" value="<?php echo $items[6]?>" style="width:100%" onBlur="updateAmount()" onKeyUp="formatNumber(this,'dot')" readonly></td>
			<td><input type="text" class="fmtn" name="_cus_it_amount[]" value="<?php echo number_format((double)$items[7])?>" style="width:100%" readonly></td>
			<td><input type="text" class="fmt" name="_cus_it_remark[]" value="<?php echo $items[8]?>" style="width:100%"></td>
			<td align="center">
				<a href="javascript:deleteCusItem('<?php echo trim($items[1])?>')"><img src='../../_images/icon/delete.gif' width='12px'></a>
				<input type="hidden" name="_cus_it_icat_midx[]" value="<?php echo $items[0]?>">
			</td>
		</tr>
<?php
	}
