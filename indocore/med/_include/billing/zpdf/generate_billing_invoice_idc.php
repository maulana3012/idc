...
/*	9	*/	if($_dept == 'A' && $_type_invoice==0) {
				...
				$pdf->MultiCell(170, 3.5, "Pengiriman dengan ekspedisi, harap Surat Jalan dicap, ditandatangani dan diberi nama jelas kemudian di fax ke ".$company[0]." setelah barang diterima.");
				$pdf->setFont('Arial', '', 9);
				$pdf->setXY(22, 244);
