...
END;
	...
	foreach($group1 as $total2 => $group2) {
		...
		foreach($group2 as $total3 => $group3) {
			...
			if($department=='A') cell($rd[$rdIdx][6]."<br />".$rd[$rdIdx][7], ' style="'.$display_css[$rd[$rdIdx][20]].'" valign="top" align="center" rowspan="'.$rowSpan.'"');	//Invoice sales period
	...
	print "<tr>\n";
	cell("<b>$total1</b>", ' colspan="'.$t_col.'" align="right" style="color:brown; background-color:lightyellow"');
...
END;
	...
	print "<tr>\n";
	cell("<b>GRAND TOTAL</b>", ' colspan="'.$t_col.'" align="right" style="color:brown; background-color:lightyellow"');
