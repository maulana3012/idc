...
SELECT
  ...
  (reit.reit_unit_price * (1 - turn.turn_discount/100)) AS it_unit_price,
...
FROM
  ".ZKP_SQL."_tb_customer AS cus
  JOIN ".ZKP_SQL."_tb_dt AS dt ON cus.cus_code = dt.dt_cus_to
...
FROM
  ".ZKP_SQL."_tb_customer AS cus
  JOIN ".ZKP_SQL."_tb_df AS df ON cus.cus_code = df.df_cus_to
...
FROM
  ".ZKP_SQL."_tb_customer AS cus
  JOIN ".ZKP_SQL."_tb_dr AS dr ON cus.cus_code = dr.dr_cus_to
...
FROM
  ".ZKP_SQL."_tb_customer AS cus
  JOIN ".ZKP_SQL."_tb_return_dt AS rdt ON cus.cus_code = rdt.rdt_cus_to
