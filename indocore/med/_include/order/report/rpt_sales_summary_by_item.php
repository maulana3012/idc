...
WHERE " . $strWhere . "
ORDER BY icat.icat_pidx, it.icat_midx, it.it_code, cus.cus_code, sl_date DESC";
...
while($col =& fetchRowAssoc($res)) {
	...
	if($cache[2] != $col['cus_code']) {
		...
		$group0[$col['icat_midx']][$col['it_code']][$col['cus_code']] = array();
	}
	...
	$group0[$col['icat_midx']][$col['it_code']][$col['cus_code']][$col['sl_idx']] = 1;
}
...
END;
	...
	foreach($group1 as $total2 => $group2) {
		...
		foreach($group2 as $total3 => $group3) {
			...
			cell($rd[$rdIdx][4], ' valign="top" rowspan="'.$rowSpan.'"'); //cus_full_name
			$print_tr_3 = 0;
		...
		print "<tr>\n";
		cell($model_name, ' colspan="7" align="right" style="color:darkblue"');
