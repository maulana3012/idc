...
WHERE inv_dept = '$department'
GROUP BY cus_code, cus_full_name, icat_midx 
ORDER BY cus_code, icat_midx";
...
while($col =& fetchRowAssoc($res)) {
	...
	$group0[$col['cus_code']][$col['icat_midx']] = 1;
}
...
foreach ($group0 as $group1) {
	...
	echo "<span class=\"comment\"><b>[". trim($rd[$rdIdx][0]). "] ".$rd[$rdIdx][12]."</b></span>\n";
	print <<<END
