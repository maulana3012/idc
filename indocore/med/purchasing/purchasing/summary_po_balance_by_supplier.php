...
//GLOBAL
$left_loc = "summary_po_balance_by_supplier.php";
...
$_curr	= isset($_GET['cboCurrency']) ? $_GET['cboCurrency'] : "all";
...
?>
<h4>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] PO BALANCE by supplier</h4>
<div align="right">
...
<table width="100%" class="table_box">
	<tr>
		<td align="right">
			<a href="<?php echo HTTP_DIR . "$currentDept/$moduleDept/" ?>summary_po_balance_by_item.php?<?php echo getQueryString()?>">View By Item</a>
		</td>
	</tr>
</table>
<?php require_once APP_DIR . "_include/purchasing/report/purchasing/rpt_summary_po_balance_by_supplier.php" ?>
<script language="javascript1.2" type="text/javascript">
	var f = window.document.frmSearch;
	var ts = <?php echo time() * 1000;?>;

	setSelect(f.cboType, "<?php echo isset($_GET['cboType']) ? $_GET['cboType'] : "all"?>");
	setSelect(f.cboCurrency, "<?php echo isset($_GET['cboCurrency']) ? $_GET['cboCurrency'] : "all"?>");
...
?>
	...
	f.cboCurrency.onchange = f.cboType.onchange;
