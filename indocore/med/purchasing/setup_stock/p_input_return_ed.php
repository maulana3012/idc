...
<table width="100%" cellpadding="0">
	<tr><td colspan="2" background="../../_images/properties/p_leftmenu_bg05.gif"><img src="../../_images/p_dot.gif"></td></tr>
    <tr bgcolor=#f9f9fb>
        <td height="25"><img src="../../_images/icon/book-file.gif" align="middle">&nbsp;&nbsp;<strong>ITEM DESCRIPTION</strong></td>
    </tr>
    <tr><td colspan="2" background="../../_images/properties/p_leftmenu_bg05.gif"><img src="../../_images/p_dot.gif"></td></tr>
</table>
<table width="100%" cellpadding="0">
...
<div align="right">
		<button name="btnAdd" class="fmt" style="width:60px" onclick="createNewED()">ADD</button>
		<button name="btnClose" class="fmt" style="width:70px" onclick="window.close()">Close <img src="../../_images/icon/close_mini.gif"></button>
</div>
</body>
</html>