...
function createNewED() {
	...
	window.document.frmCreateED._expired_date.value='';
	window.document.frmCreateED._qty.value='';
	window.document.frmCreateED._expired_date.focus();
}
</script>
</head>
<body style="margin:8pt" onload="window.document.frmCreateED._expired_date.focus();">
...
<table width="100%" class="table_l">
    ...
    <tr>
    	...
    	<td>
<form name="frmCreateED" method="GET">
<input type='hidden' name='_code' value='<?php echo $_code ?>'>
<input type='hidden' name='_item' value='<?php echo $_item ?>'>
