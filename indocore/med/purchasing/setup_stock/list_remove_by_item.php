...
//Global
$left_loc 	= "list_remove_by_item.php";
?>
<html>
<head>
...
<table width="100%" class="table_box">
	<tr>
		<td align="right">
			<a href="./list_remove_by_date.php?<?php echo getQueryString()?>">View By Date</a>
		</td>
	</tr>
</table>
<?php require_once APP_DIR . "_include/purchasing/report/setup_stock/rpt_list_remove_by_item.php" ?>
