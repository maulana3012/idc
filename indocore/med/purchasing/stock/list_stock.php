...
<?php while ($column =& fetchRowAssoc($result)) { ?>
	<tr style="font-color:<?php echo $column['it_color'] ?>">
		...
		<td align="right">
			<a href="<?php echo HTTP_DIR . "$currentDept/$moduleDept/" ?>history_stock.php?_code=<?php echo urlencode(html_entity_decode($column['it_code'], ENT_QUOTES));?>&cboType=1&cboLocation=<?php echo $_location ?>">
			<font color="<?php echo $column['it_color'] ?>"><?php echo ($column['it_code']=='2101  '||$column['it_code']=='2101NE') ? number_format($column['vat_stock'],2) : number_format($column['vat_stock'])?></font>
			</a>
		</td>
		<td align="right">
			<a href="<?php echo HTTP_DIR . "$currentDept/$moduleDept/" ?>history_stock.php?_code=<?php echo urlencode(html_entity_decode($column['it_code'], ENT_QUOTES));?>&cboType=2&cboLocation=<?php echo $_location ?>">
			<font color="<?php echo $column['it_color'] ?>"><?php echo ($column['it_code']=='2101  '||$column['it_code']=='2101NE') ? number_format($column['non_stock'],2) : number_format($column['non_stock'])?></font>
			</a>
		</td>
		<td align="right"><font color="<?php echo $column['it_color'] ?>"><?php echo ($column['it_code']=='2101  '||$column['it_code']=='2101NE') ? number_format($column['total_stock'],2) : number_format($column['total_stock'])?></font></td>
	</tr>
<?php } ?>
</table>
