...
//RECEIVE DATA FROM input_po_step_3.php
if(ckperm(ZKP_INSERT, HTTP_DIR . $currentDept . '/packing_list/input_invoice_step_3.php', 'order_info')) {
...
//---------------------------------------------------------------------------------------------------- insert PL
if(ckperm(ZKP_INSERT, HTTP_DIR . $currentDept . '/packing_list/index.php', 'insert')) {
