...
//GLOBAL
$left_loc = "summary_pl_balance_by_supplier.php";
...
?>
<h4>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] PL BALANCE by supplier</h4>
	...
	<tr>
		...
		<td>
			<select name="cboSource">
                ...
                <option value="1">FROM PO</option>
                <option value="2">FROM CLAIM</option>
            </select>
		</td>
		<td>
			<select name="cboType">
...
<table width="100%" class="table_box">
	<tr>
		<td align="right">
			<a href="<?php echo HTTP_DIR ."purchasing/packing_list/" ?>summary_pl_balance_by_item.php?<?php echo getQueryString()?>">View By Item</a>
		</td>
	</tr>
</table>
<?php require_once APP_DIR . "_include/purchasing/report/packing_list/rpt_summary_pl_balance_by_supplier.php" ?>
...
?>
	...
	f.cboSource.onchange = f.cboType.onchange;
