...
//Global
$left_loc 	  = "daily_booking_demo_by_item.php";
  ...
  <tr>
    <td style="padding:0 3 3 3">
        ...
        <tr>
          	...
          	<!--START: BODY-->
			<h4>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] BOOKING DEMO SUMMARY by item</h4>
<?php
...
<table width="100%" class="table_box">
	<tr>
		<td align="right">
			<a href="./daily_booking_demo_by_reference.php?<?php echo getQueryString()?>">View By Reference</a>
		</td>
	</tr>
</table>
<?php require_once APP_DIR . "_include/demo/report/rpt_daily_booking_demo_by_item.php" ?>
