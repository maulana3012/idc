...
//request
$sql = "
SELECT *, (SELECT out_idx FROM ".ZKP_SQL."_tb_outgoing WHERE out_doc_ref='$_code' AND out_doc_type=6) AS out_idx
...
$sql_ed	= "
SELECT it_code,it_model_no,oted_date,oted_qty
FROM ".ZKP_SQL."_tb_outgoing_ed JOIN ".ZKP_SQL."_tb_item USING(it_code) WHERE out_idx = {$column["out_idx"]}";
$res_ed	=& query($sql_ed);
?>
<html>
<head>
