...
if(numQueryRows($result) <= 0) {
	...
	goPage(HTTP_DIR . "$currentDept/$moduleDept/detail_request.php?_code=".urlencode($column['req_code']));
}
...
<table width="100%" cellpadding="2" cellspacing="0">
	<tr>
		<td>
			<button name='btnDelete' class='input_btn' style='width:120px;'><img src="../../_images/icon/trash.gif" width="15px" align="middle" alt="Delete request"> &nbsp; Delete request</button>
		</td>
		<td align="right">
			Rev No:
...
<script language="javascript" type="text/javascript">
	...
	window.document.all.btnList.onclick = function() {
		window.location.href = '<?php echo HTTP_DIR . $currentDept . '/request_demo/daily_request_demo_by_reference.php' ?>';
	}
</script>
            <!--END: BODY-->
          </td>
