...
<strong>
[<font color="blue"><?php echo strtoupper($currentDept) ?></font>] ITEM LIST (STEP 2 / 2)<br />
...
<div style="height:290; overflow-y:scroll">
...
<table width="100%" class="table_box">
	...
	<tr>
		<td>
			<button name='btnBack' class='input_sky' style='width:50px;height:25px' onclick="window.location.href='p_list_item_return_1.php'"><img src="../../_images/icon/back.gif" align="middle" alt="Back"></button>
		</td>
