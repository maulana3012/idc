...
//------------------------------------------------------------------
$cat = array("New Document", "Summary", "DT Summary");
//------------------------------------------------------------------
...
//------------------------------------------------------------------
$item0[] = "input_do_step_1.php::New DO";

$item1[] = "daily_summary_by_item.php::By Item";
$item1[] = "daily_summary_by_group.php::By Group";

$item2[] = "daily_dt_summary_by_item.php::By Item";
$item2[] = "daily_dt_summary_by_group.php::By Group";
//------------------------------------------------------------------
