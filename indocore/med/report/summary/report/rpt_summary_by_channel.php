...
if(ZKP_FUNCTION == 'ALL') {
	...
	if($cboFilter[1][ZKP_URL][0][0] == '1') {
		$tmp_paid[] 	= "substr(bill_code,1,1) = 'B' AND ".ZKP_SQL."_isValidShowInvoice('".ZKP_URL."', b.bill_code,'billing')";
	} else if($cboFilter[1][ZKP_URL][0][0] == '2') {
		$tmp_sv[]		= "sv_code is null";
		$tmp_svpay[]	= "sv_code is null";
		$tmp_paid[] 	= "substr(bill_code,1,1) = 'S' AND ".ZKP_SQL."_isValidShowInvoice('".ZKP_URL."', b.bill_code,'billing')";
	}
}
