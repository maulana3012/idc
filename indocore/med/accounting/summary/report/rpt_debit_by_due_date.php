...
END;
	...
	foreach ($month as $week_name => $due_week) {
		...
		print "<tr>\n";
			...
			cell(number_format($rd[$rdIdx][10]), ' style="'.$display_css[$rd[$rdIdx][19]].'" align="right"');	//amount
			cell(number_format($rd[$rdIdx][11]), ' style="'.$display_css[$rd[$rdIdx][19]].'" align="right"');	//delivery charge
			cell(number_format($rd[$rdIdx][12]), ' style="'.$display_css[$rd[$rdIdx][19]].'" align="right"');	//vat
			cell(number_format($rd[$rdIdx][13]), ' style="'.$display_css[$rd[$rdIdx][19]].'" align="right"');	//amount+vat
			cell(number_format($rd[$rdIdx][14]), ' style="'.$display_css[$rd[$rdIdx][19]].'" align="right"');	//amount +vat+freight
			cell(number_format($rd[$rdIdx][15]), ' style="'.$display_css[$rd[$rdIdx][19]].'" align="right"');	//paid
			cell(number_format($rd[$rdIdx][16]), ' style="'.$display_css[$rd[$rdIdx][19]].'" align="right"');	// Remain amount
		...
		cell(number_format($weekly_summary[3]), ' align="right" style="color:darkblue"');
		cell(number_format($weekly_summary[4]), ' align="right" style="color:darkblue"');
		cell(number_format($weekly_summary[5]), ' align="right" style="color:darkblue"');
		cell(number_format($weekly_summary[6]), ' align="right" style="color:darkblue"');
