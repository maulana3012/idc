...
while($col =& fetchRowAssoc($res)) {
	...
	if($cache[1] != $col['icat_pidx'].$col['it_code']) {
		$cache[1] = $col['icat_pidx'].$col['it_code'];
...
END;
	...
	foreach($group1 as $total2 => $group2) {
		...
		foreach($group2 as $total3 => $group3) {
			...
			foreach($group3 as $total4 => $group4) {
				...
				cell(number_format($rd[$rdIdx][8]), ' style="'.$display_css[$rd[$rdIdx][16]].'" align="right"');	//unit price
				cell(number_format($rd[$rdIdx][9]), ' style="'.$display_css[$rd[$rdIdx][15]].'" align="right"');	//qty
				cell(number_format($rd[$rdIdx][10]), ' style="'.$display_css[$rd[$rdIdx][16]].'" align="right"');	//amount
				cell(number_format($rd[$rdIdx][11]), ' style="'.$display_css[$rd[$rdIdx][16]].'" align="right"');	//vat
				cell(number_format($rd[$rdIdx][12]), ' style="'.$display_css[$rd[$rdIdx][16]].'" align="right"');	//amount + vat
				print "</tr>\n";
		...
		cell(number_format($model_total[0]), ' align="right" style="color:darkblue"');
		cell(number_format($model_total[1]), ' align="right" style="color:darkblue"');
		cell(number_format($model_total[2]), ' align="right" style="color:darkblue"');
		cell(number_format($model_total[3]), ' align="right" style="color:darkblue"');
		print "</tr>\n";
	...
	cell(number_format($cat_total[3]), ' align="right" style="color:brown; background-color:lightyellow"');
	print "</tr>\n";
	print "</table><br />\n";
