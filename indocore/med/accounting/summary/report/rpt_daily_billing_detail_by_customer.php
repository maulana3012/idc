...
if ($_last_category != 0) {
	$catList = executeSP(ZKP_SQL."getSubCategory", $_last_category);
...
$tmp_bill[] = "c.cus_code = '$_cus_code'";
$tmp_turn[] = "c.cus_code = '$_cus_code'";
$tmp_dr[]	= "c.cus_code = '$_cus_code'";
...
SELECT
  ...
  'billing' AS invoice_layout_qty,
  'billing' AS invoice_layout_amount,
  '../_other/revise_dr.php?_code='||dr_code AS go_page
FROM
  ".ZKP_SQL."_tb_customer AS c
