...
<table width="100%" class="table_layout">
	<tr>
		<td width="80%" rowspan="2"><h3>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] BILLING SUMMARY by group</h3></td>
		<td> ORDER BY </td>
		<td> PUSAT </td>
	</tr>
	<tr>
...
<?php include "./report/rpt_daily_billing_detail_by_group.php"; ?>
