...
$sql .= " ORDER BY icat_pidx, icat_midx, it_code, invoice_date, invoice_code";
/*
echo "<pre>";
var_dump($sql_dr);
echo "</pre>";
...
while($col =& fetchRowAssoc($res)) {
	...
	if($cache[2] != $col['invoice_source']) {
		...
		$group0[$col['icat_pidx'].$col['icat_midx']][$col['it_code']][$col['invoice_source']] = array();
	}
	...
	$group0[$col['icat_pidx'].$col['icat_midx']][$col['it_code']][$col['invoice_source']][$col['it_idx']] = 1;
}
