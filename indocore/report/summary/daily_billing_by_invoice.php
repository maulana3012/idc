...
SELECT
  ...
  CASE
	WHEN b.bill_ordered_by = 1 AND b.bill_dept = 'A' THEN 'http://192.168.1.88/idc/apotik/billing/revise_billing.php?_code='||bill_code
	WHEN b.bill_ordered_by = 1 AND b.bill_dept = 'D' THEN 'http://192.168.1.88/idc/dealer/billing/revise_billing.php?_code='||bill_code
	WHEN b.bill_ordered_by = 1 AND b.bill_dept = 'H' THEN 'http://192.168.1.88/idc/hospital/billing/revise_billing.php?_code='||bill_code
	WHEN b.bill_ordered_by = 1 AND b.bill_dept = 'M' THEN 'http://192.168.1.88/idc/marketing/billing/revise_billing.php?_code='||bill_code
	WHEN b.bill_ordered_by = 1 AND b.bill_dept = 'P' THEN 'http://192.168.1.88/idc/pharmaceutical/billing/revise_billing.php?_code='||bill_code
	WHEN b.bill_ordered_by = 1 AND b.bill_dept = 'T' THEN 'http://192.168.1.88/idc/tender/billing/revise_billing.php?_code='||bill_code
	WHEN b.bill_ordered_by = 2 AND b.bill_dept = 'A' THEN 'http://192.168.1.88/mep/apotik/billing/revise_billing.php?_code='||bill_code
	WHEN b.bill_ordered_by = 2 AND b.bill_dept = 'D' THEN 'http://192.168.1.88/mep/dealer/billing/revise_billing.php?_code='||bill_code
	WHEN b.bill_ordered_by = 2 AND b.bill_dept = 'H' THEN 'http://192.168.1.88/mep/hospital/billing/revise_billing.php?_code='||bill_code
	WHEN b.bill_ordered_by = 2 AND b.bill_dept = 'M' THEN 'http://192.168.1.88/mep/marketing/billing/revise_billing.php?_code='||bill_code
	WHEN b.bill_ordered_by = 2 AND b.bill_dept = 'P' THEN 'http://192.168.1.88/mep/pharmaceutical/billing/revise_billing.php?_code='||bill_code
	WHEN b.bill_ordered_by = 2 AND b.bill_dept = 'T' THEN 'http://192.168.1.88/mep/tender/billing/revise_billing.php?_code='||bill_code
  END AS go_page
FROM
