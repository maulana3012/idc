...
//GLOBAL
$left_loc	= "summary_monthly_bill_customer_by_amount.php";
...
<table width="100%" class="table_layout">
	<tr>
		<td width="80%" rowspan="2"><h3>[<font color="#446fbe">GENERAL</font>] SUMMARY MONTHLY by customer</h3></td>
...
<iframe id="rightFrame" src="i_summary_monthly_bill_customer_by_amount.php?<?php echo getQueryString()?>" frameborder="0" width="100%" height="500px" name="iFrm"></iframe><br /><br />
