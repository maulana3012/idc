...
switch (ZKP_URL) {
	...
	case "ALL":
		...
		if($_chk_company == 'off') {
			$tmp_billing1[0][]	= "bill_ship_to NOT IN ('0MDS', '0SMD')";
			$tmp_billing2[0][]	= "bill_ship_to NOT IN ('0MDS', '0SMD')";
			$tmp_service[0][]	= "sv_cus_to NOT IN ('0MDS', '0SMD')";
			$tmp_billing1[1][]	= "bill_ship_to NOT IN ('6IDC', '0MDS', '0SMD')";
			$tmp_billing2[1][]	= "bill_ship_to NOT IN ('6IDC', '0MDS', '0SMD')";
			$tmp_service[1][]	= "sv_cus_to NOT IN ('6IDC', '0MDS', '0SMD')";
		}
	...
	case "IDC":
		...
		if($cboSearchType != '' && $txtSearch != '') {
			...
			$tmp_billing1[0][] = "idc_isPayDescTrue({$searchType[$cboSearchType]}, pay_idx, '%$txtSearch%') = true";
			$tmp_billing2[0][] = "idc_isPayDescTrue({$searchType[$cboSearchType]}, pay_idx, '%$txtSearch%') = true";
			if($searchType[$cboSearchType] == 1)		$tmp_service[0][] = "idc_isPayDescTrue(3, svpay_idx, '%$txtSearch%') = true";
			else if($searchType[$cboSearchType] == 1)	$tmp_service[0][] = "svpay_idx IS NULL";
			else if($searchType[$cboSearchType] == 2)	$tmp_service[0][] = "svpay_idx IS NULL";
		}
	...
	case "MED":
		...
		if($cboSearchType != '' && $txtSearch != '') {
			...
			if($searchType[$cboSearchType] == 1)		$tmp_service[1][] = "idc_isPayDescTrue(3, svpay_idx, '%$txtSearch%') = true";
			else if($searchType[$cboSearchType] == 1)	$tmp_service[1][] = "svpay_idx IS NULL";
			else if($searchType[$cboSearchType] == 2)	$tmp_service[1][] = "svpay_idx IS NULL";
		}
