...
include "rpt_summary_monthly_bill_customer_by_amount_print_1.php";
include "rpt_summary_monthly_bill_customer_by_amount_print_2.php";
include "rpt_summary_monthly_bill_customer_by_amount_print_3.php";
?>