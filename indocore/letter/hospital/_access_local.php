...
$grMember = array(
	...
	'letter_summary'	=>array(15,130,0),
	'letter_apotik'		=>array(16,131,0),
	'letter_dealer'		=>array(17,132,0),
	'letter_hospital'	=>array(18,133,0),
	'letter_pharmaceutical' =>array(19,134,0),
	'letter_general'	=>array(20,135,0),
	'letter_management'	=>array(21,136,0)
);
...
foreach($grMember as $key => $val) {
	if($currentDept != "letter") {
		...
		if('letter_'.$moduleDept == $key) $grMember[$key][2] = 15;
	}
}
