...
//GLOBAL
$left_loc = "summary_delivery_by_group.php";
...
$_sort_by	= isset($_GET['cboSortBy']) ? $_GET['cboSortBy'] : "all";
...
$_sort_date	= isset($_GET['cboSortDate']) ? $_GET['cboSortDate'] : "deli";
...
<table width="100%" class="table_layout">
	<tr>
		<td width="90%" rowspan="2"><h4>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] SUMMARY DELIVERY ORDER by group</h4></td>
...
<table width="100%" class="table_box">
	<tr>
		<td align="right">
			<a href="<?php echo HTTP_DIR . "$currentDept/$moduleDept/" ?>summary_delivery_by_item.php?<?php echo getQueryString()?>">View By Item</a>
		</td>
	</tr>
</table><br />
<?php require_once APP_DIR . "_include/order/report/rpt_summary_delivery_detail_by_group.php" ?>
<script language="javascript1.2" type="text/javascript">
	var f = window.document.frmSearch;
	var ts = <?php echo time() * 1000;?>;

	setSelect(f.cboSortBy, "<?php echo isset($_GET['cboSortBy']) ? $_GET['cboSortBy'] : "all"?>");
	setSelect(f.cboSortDate, "<?php echo isset($_GET['cboSortDate']) ? $_GET['cboSortDate'] : "deli"?>");
...
?>
	...
	f.cboSortBy.onchange		= f._cug_code.onchange;
	f.cboSortDate.onchange		= f._cug_code.onchange;
