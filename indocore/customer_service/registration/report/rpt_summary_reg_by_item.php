...
END;
	...
	foreach($group1 as $total2 => $group2) {
		...
		foreach($group2 as $total3 => $group3) {
			...
			cell_link("<b>".$rd[$rdIdx][4]."</b>", ' align="center" ', ' href="'.$rd[$rdIdx][15].'"');
			cell($rd[$rdIdx][5], ' align="center"');
			cell($rd[$rdIdx][7]);
			cell($rd[$rdIdx][8]);
			cell($rd[$rdIdx][9]);
			cell($rd[$rdIdx][10]);
			cell($rd[$rdIdx][11], ' align="center"');
			cell($rd[$rdIdx][12]);
			cell($rd[$rdIdx][13], ' align="center"');
			cell(number_format($rd[$rdIdx][14]), ' align="right"');
			print "</tr>\n";
