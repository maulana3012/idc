	...
	<tbody>
		<tr>
			...
			<th width="15%" rowspan="2">
				<button name='btnAdd' class='input_sky' style='width:50px;height:20px' onclick='createNewItem()'><img src="../../_images/icon/add.gif" width="18px" align="middle" alt="Add item"></button>
				<button name='btnClose' class='input_sky' style='width:50px;height:20px' onclick='window.close()'><img src="../../_images/icon/delete.gif" width="15px" align="middle" alt="Close pop-up"></button>
			</th>
		</tr>
		<tr>
