...
<table width="100%" class="table_box">
	...
	<tr>
		...
		<th>NPWP</th>
		<td>
			<input type="text" name="_type_of_biz" class="fmt"> CODE			
			<input type="radio" name="_tax_code_status" value="1" checked>1 &nbsp;
			<input type="radio" name="_tax_code_status" value="2">2<br />
			  <small>Code <b>1</b> for general customer, <b>2</b> for spesific cust, ex : Bendahara xxx, contact accounting for further info</small>
		</td>
	</tr>
</table><br />
...
<table width="100%" class="table_box">
	<tr>
		...
		<td><input type="text" name="_phone" class="fmt"></td>
	</tr>
	<tr>
		<th>FAX</th>
		<td colspan="3"><input type="text" name="_fax" class="fmt"></td>
	</tr>
	<tr>
		<th>CITY</th>
		<td colspan="3"><input type="text" name="_city" class="fmt"></td>
	</tr>
    <tr>
		<th>REMARKS</th>
