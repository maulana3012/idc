...
function checkform(o) {
	var d1 = parseDate(o._po_date.value, 'prefer_euro_format');
	var d2 = parseDate(o._ord_date.value, 'prefer_euro_format');

	if (verify(o)) {
		if(d1 < d2) {
			alert("Order Date have to earlier than Return Date");
			o._ord_date.focus();
			return;
		}
		o.submit();
