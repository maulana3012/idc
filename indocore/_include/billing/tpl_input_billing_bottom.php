...
<table class="table_box" width="100%">
	...
	<tr>
		...
		<td>
			...
			<input type="radio" name="_bank" value="BCA2" onCLick="bankDesc(this.value)" id="bca2" disabled><label for="bca2">BCA 2</label><br />
			<input type="radio" name="_bank" value="MANDIRI" onCLick="bankDesc(this.value)" id="mandiri" disabled><label for="mandiri">Mandiri</label><br />
		</td>
		<td>
			<input type="radio" name="_bank" value="BII1" onCLick="bankDesc(this.value)" id="bii1" disabled><label for="bii1">BII 1</label><br />
			<input type="radio" name="_bank" value="BII2" onCLick="bankDesc(this.value)" id="bii2" disabled><label for="bii2">BII 2</label><br />
        ...
        <td colspan="2">
			<input type="radio" name="_bank" value="DANAMON3" onCLick="bankDesc(this.value)" id="danamon3" disabled><label for="danamon3">DANAMON</label><br />
		</td>
		<?php } ?>
		<td colspan="2">
...
<table width="100%" class="table_box">
	...
	<tr>
		...
		<td colspan="3">
			...
			<input type="radio" name="_signature_pajak_by" value="B" id="signB"><label for="signB">Ratna Afrianti</label>
		</td>
	</tr>
    <?php } else if($_ordered_by == 2) { ?>
    <tr>
		<th>SIGN PAJAK BY</th>
		<td colspan="3">
			<input type="radio" name="_signature_pajak_by" value="A" id="signA" checked><label for="signa">Min Sang Hyun</label>
			<input type="radio" name="_signature_pajak_by" value="B" id="signB"><label for="signB">Dahlia Sana Buwana</label>
		</td>
	</tr>
    <?php } } ?>
