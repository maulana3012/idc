...
?>
		<tr id="<?php echo trim($items[1])?>">
			...
			<td><input type="text" class="fmtn" name="_cus_it_qty[]" value="<?php echo $items[6]?>" style="width:100%" onBlur="updateAmount()" onKeyUp="formatNumber(this,'dot')"></td>
...
function fillItem(){
	...
	wSearchItem = window.open(
		'./p_list_item.php?_cus_code=<?php echo $_cus_to ?>','wSearchItem',
