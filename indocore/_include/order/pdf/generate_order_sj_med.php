...
/*	6	*/	$pdf->setXY(22, 235);
			if($department == 'A') {
				...
				$pdf->MultiCell(175, 3.5, "Untuk pengiriman dengan Expedisi, apbila barang telah diterima harap surat jalan di tanda tangani, nama jelas dan stempel kemudian di fax ke PT. Medisindo ( Up. Dewi )");
				$pdf->setFont('Arial', '', 9);
				$pdf->MultiCell(180, 3.5, $_remark);
			} else {
				$pdf->setFont('Arial', '', 9);
				$pdf->MultiCell(180, 3.5, $_remark);
			}
