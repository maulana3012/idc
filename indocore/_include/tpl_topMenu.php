...
if(ZKP_URL == 'ALL') {
	...
	include APP_DIR . "_system/util_tabmenu_smd.php";
}
...
$init = array("admin"=>"admin", "accounting"=>"accounting", "report"=>"report", "report_all"=>"report", 
			  ...
			  "pharmaceutical"=>"pharmaceutical", "tender"=>"tender", "customer_service"=>"CS", "incentive"=>"incentive",
...
$availTab = array(
			 ...
			 "department"=>array("admin","apotik","dealer","hospital","marketing","pharmaceutical","tender","customer_service","incentive"),
