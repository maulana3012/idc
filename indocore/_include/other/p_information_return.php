...
<strong>
[<font color="blue"><?php echo strtoupper($currentDept) ?></font>] RETURN REPLACE SUMMARY<br />
<small>* Printed in DO replace as RR reference</small>
</strong>
<hr><br />
<table width="100%" class="table_box">
	<tr>
		<th align="right">Cannot click the return? The return is disabled??</th>
	</tr>
</table><br />
<span style="font-family:verdana;font-size:0.9em">Disabled return(s) :</span>
<ul style="font-family:verdana;font-size:0.9em">
	<li>Return &nbsp;<code style="color:#004686">Issue Item</code>&nbsp; is unconfirmed.</li>
</ul><br />
<table width="100%" class="table_box">
	<tr>
		<td></td>
