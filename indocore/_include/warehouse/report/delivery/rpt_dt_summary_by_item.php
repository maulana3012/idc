...
END;
	...
	foreach($group1 as $total2 => $group2) {
		...
		foreach($group2 as $total3 => $group3) {
			...
			foreach($group3 as $total4 => $group4) {
				...
				cell(number_format($rd[$rdIdx][10]), ' align="right"');				//DT qty
				cell(number_format($rd[$rdIdx][11]), ' align="right"');				//RT qty 
				if($bal_qty < 0)
	...
	cell(number_format($gTotal[1]), ' align="right" style="color:brown; background-color:lightyellow"');
