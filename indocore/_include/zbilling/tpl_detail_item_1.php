...
<?php while($items =& fetchRow($whitem_res)) { ?>
		<tr id="<?php echo trim($items[0])?>">
			...
			<td><input type="text" name="_wh_it_model_no[]" class="fmt" style="width:100%" value="<?php echo $items[2]?>" readOnly></td>
			<td><input type="text" name="_wh_it_desc[]" class="fmt" style="width:100%" value="<?php echo $items[4]?>" readOnly></td>
			<td><input type="text" name="_wh_it_qty[]" class="reqn" style="width:100%" value="<?php echo number_format((double)$items[6],2)?>" readOnly></td>
			<td><input type="text" name="_wh_it_function[]" class="fmtn" style="width:100%" value="<?php echo $items[7]?>" readOnly></td>
			<td><input type="text" name="_wh_it_remark[]" class="fmt" style="wifth:100%" value="<?php echo $items[8]?>"></td>
			<td align="center"><a href="javascript:deleteWHItem('<?php echo trim($items[0])?>')"><img src='../../_images/icon/delete.gif' width='12px'></a></td>
		</tr>
<?php } ?>
	</tbody>
</table>
...
<?php while($items =& fetchRow($cusitem_res)) { ?>
		<tr id="<?php echo trim($items[0])?>">
			...
			<td align="right"><input type="text" name="_cus_it_unit_price[]" class="reqn" style="width:100%" value="<?php echo number_format((double)$items[5])?>" onBlur="updateAmount()" onKeyUp="formatNumber(this,'dot')"></td>
			...
			<td align="center" colspan="3">
				...
				<input type="hidden" name="_cus_it_icat_midx[]" value="<?php echo $items[1]?>">
				<input type="hidden" name="_cus_it_type[]" value="<?php echo $items[3]?>">
			</td>
		</tr>
<?php } ?>
	</tbody>
