...
END;
	...
	foreach($group1 as $total2 => $group2) {
		...
		foreach($group2 as $total3 => $group3) {
			...
			cell(number_format($cust_amount), ' align="right"');	//customer amount
			cell(number_format($rate,2)." %", ' align="right"');	//customer percentage
			if($a != $rd[$rdIdx][1]) {
		...
		cell(number_format($group_amount[0]), ' align="right" style="color:darkblue;"');	//customer group amount
		cell(number_format($group_amount[1],2)." %", ' align="right" style="color:darkblue;"');	//customer total percentage
	...
	cell(number_format($dept_amount[0]), ' align="right" style="color:brown; background-color:lightyellow"');			//dept total billing amount before vat
	cell('', ' align="right" style="color:brown; background-color:lightyellow"');										//
	cell(number_format($dept_amount[1],2)." %", ' align="right" style="color:brown; background-color:lightyellow"');	//dept total percentage
	print "</tr>\n";
	print "</table><br />\n";
