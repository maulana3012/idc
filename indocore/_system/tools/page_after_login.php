...
*
*
* $Id: page_after_login.php,v 1.1 2008/04/28 06:52:13 neki Exp $
*/
...
?>
    ...
    <tr>
        <td width="10%" align="center" valign="top" style="padding:0 0 0 10" bgcolor="#F0F5F6" height="440" width="140">&nbsp;</td>
...
<table class="table_g" width="60%" align="center">
	...
	<tr>
		<td colspan="2" height="40" align="center">You've just logged in successfully.</td>
	</tr>
</table>
<br>
<table class="table_no" width="40%" align="center">
	<tr>
		<td align="center">
			<input type="button" name="btnConfirm" value="Confirm" onClick="window.location.href='<?php echo empty($_REQUEST['returnUrl'])? MAIN_PAGE : urldecode($_REQUEST['returnUrl'])?>'" class="input_sky">
		</td>
	</tr>
</table>
<!--END BODY-->
