...
<table width="100%" class="table_layout">
    <tr>
        <td width="70%" rowspan="2"><h4>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] RETURN DEMO SUMMARY by reference</h4></td>
        <td> CATEGORY </td>
    </tr>
        <td>
...
<?php require_once APP_DIR . "_include/demo/report/rpt_daily_return_demo_by_reference.php" ?>
