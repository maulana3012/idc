...
//Global
$left_loc 	  = "daily_using_balance_by_item.php";
...
<table width="100%" class="table_layout">
    <tr>
        <td width="70%" rowspan="2"><h4>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] REQUEST BALANCE SUMMARY by item</h4></td>
        <td> CATEGORY </td>
    </tr>
        <td>
...
<table width="100%" class="table_box">
	<tr>
		<td align="right">
			<a href="./daily_using_balance_by_reference.php?<?php echo getQueryString()?>">View By Reference</a>
		</td>
	</tr>
</table>
<?php require_once APP_DIR . "_include/demo/report/rpt_daily_using_balance_by_item.php" ?>
