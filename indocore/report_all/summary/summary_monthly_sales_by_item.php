...
<table width="100%" class="table_layout">
	<tr>
		<td width="70%" rowspan="2"><h3>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] MONTHLY SALES SUMMARY by item</h3></td>
		<td> SHIP TO </td>
		...
		<td><div class="divOrderBy">
			<input type="checkbox" name="chkCompany" <?php echo ($_chk_company == 'on') ? ' checked' : '' ?> onclick="submitSearch()">
...
?>
	...
	function submitSearch() {
		if(f._cug_code.value != 'all' && f._cus_code.value != '') {
			f._cus_code.value = '';
		}
