...
if ($_last_category != 0) {
	...
	$tmp_sl[1][]		= "bill_type_billing = 3";
		...
		if($_chk_company == 'off') {
			...
			$tmp_sl[0][]		= "bill_code NOT IN ('6IDC', '0MSD', '0SMD')";
			$tmp_bill[1][]		= "bill_ship_to NOT IN ('6IDC', '6IDC', '0MSD', '0SMD')";
			$tmp_turn[1][]		= "turn_ship_to NOT IN ('6IDC', '6IDC', '0MSD', '0SMD')";
			$tmp_sl[1][]		= "bill_code NOT IN ('6IDC', '6IDC', '0MSD', '0SMD')";
			$tmpbill_item[0][]	= "a.bill_ship_to NOT IN ('6IDC', '0MSD', '0SMD')";
			$tmpturn_item[0][]	= "a.turn_ship_to NOT IN ('6IDC', '0MSD', '0SMD')";
			$tmpdr_item[0][]	= "a.bill_ship_to NOT IN ('6IDC', '0MSD', '0SMD')";
			$tmpbill_item[1][]	= "a.bill_ship_to NOT IN ('6IDC', '0MSD', '0SMD')";
			$tmpturn_item[1][]	= "a.turn_ship_to NOT IN ('6IDC', '0MSD', '0SMD')";
			$tmpdr_item[1][]	= "a.bill_ship_to NOT IN ('6IDC', '0MSD', '0SMD')";
		}
