...
switch (ZKP_URL) {
	...
	case "ALL":
		...
		if($_chk_company == 'off') {
			$tmp_billing1[0][]	= "c.cus_code NOT IN ('6IDC', '0MSD', '0SMD')";
			$tmp_billing2[0][]	= "c.cus_code NOT IN ('6IDC', '0MSD', '0SMD')";
			$tmp_service[0][]	= "c.cus_code NOT IN ('6IDC', '0MSD', '0SMD')";
			$tmp_billing1[1][]	= "c.cus_code NOT IN ('6IDC', '0MSD', '0SMD')";
			$tmp_billing2[1][]	= "c.cus_code NOT IN ('6IDC', '0MSD', '0SMD')";
			$tmp_service[1][]	= "c.cus_code NOT IN ('6IDC', '0MSD', '0SMD')";
		}
