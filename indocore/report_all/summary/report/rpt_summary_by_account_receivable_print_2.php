...
print <<<END
	...
	<table width="1735px" class="table_f">
		<tr>
			...
			<th width="420px" colspan="8">CHECK</th>
			<th width="630px" colspan="10">TRANSFER</th>
			<th width="420px" colspan="8">GIRO</th>
			<th width="80px" rowspan="2">TOTAL</th>
		</tr>
		<tr>
			<th width="70px"><i>OLD</i></th>
			<th width="70px">BCA</th>
			<th width="70px">BII2</th>
			<th width="70px">BII3</th>
			<th width="70px">DANAMON</th>
			<th width="70px">DANAMON2</th>
			<th width="70px">DANAMON3</th>
...
foreach ($channel as $value => $key) {
	...
	cell((isset($amount[$value]['check']['BCA1']))		? number_format((double)$amount[$value]['check']['BCA1'])	: '', ' align="right"');
	...
	cell((isset($amount[$value]['check']['DANAMON3']))	? number_format((double)$amount[$value]['check']['DANAMON3'])	: '', ' align="right"');
	...
	cell((isset($amount[$value]['transfer']['DANAMON3']))	? number_format((double)$amount[$value]['transfer']['DANAMON3']): '', ' align="right"');
	...
	cell((isset($amount[$value]['giro']['BCA1']))		? number_format((double)$amount[$value]['giro']['BCA1'])	: '', ' align="right"');
	...
	cell((isset($amount[$value]['giro']['DANAMON3']))	? number_format((double)$amount[$value]['giro']['DANAMON3'])	: '', ' align="right"');
	...
	$total[2]  += (isset($amount[$value]['check']['BCA1']))			? $amount[$value]['check']['BCA1']		: 0;
	$total[3]  += (isset($amount[$value]['check']['BII2']))			? $amount[$value]['check']['BII2']		: 0;
	$total[4]  += (isset($amount[$value]['check']['BII3']))			? $amount[$value]['check']['BII3']		: 0;
	$total[5]  += (isset($amount[$value]['check']['DANAMON']))		? $amount[$value]['check']['DANAMON']		: 0;
	$total[6]  += (isset($amount[$value]['check']['DANAMON2']))		? $amount[$value]['check']['DANAMON2']		: 0;
	$total[7]  += (isset($amount[$value]['check']['DANAMON3']))		? $amount[$value]['check']['DANAMON3']		: 0;
	$total[8]  += (isset($amount[$value]['check']['BNIS']))			? $amount[$value]['check']['BNIS']		: 0;

	$total[9]  += (isset($amount[$value]['transfer']['BCA1']))		? $amount[$value]['transfer']['BCA1']		: 0;
	$total[10]  += (isset($amount[$value]['transfer']['BCA2']))		? $amount[$value]['transfer']['BCA2']		: 0;
	$total[11] += (isset($amount[$value]['transfer']['MANDIRI']))		? $amount[$value]['transfer']['MANDIRI'] 	: 0;
	$total[12] += (isset($amount[$value]['transfer']['BII1']))		? $amount[$value]['transfer']['BII1']		: 0;
	$total[13] += (isset($amount[$value]['transfer']['BII2']))		? $amount[$value]['transfer']['BII2']		: 0;
	$total[14] += (isset($amount[$value]['transfer']['BII3']))		? $amount[$value]['transfer']['BII3']		: 0;
	$total[15] += (isset($amount[$value]['transfer']['DANAMON']))		? $amount[$value]['transfer']['DANAMON']	: 0;
	$total[16] += (isset($amount[$value]['transfer']['DANAMON2']))		? $amount[$value]['transfer']['DANAMON2']	: 0;
	$total[17] += (isset($amount[$value]['transfer']['DANAMON3']))		? $amount[$value]['transfer']['DANAMON3']	: 0;
	$total[18] += (isset($amount[$value]['transfer']['BNIS']))		? $amount[$value]['transfer']['BNIS']		: 0;

	$total[19] += (isset($amount[$value]['giro']['']))			? $amount[$value]['giro']['']			: 0;
	$total[20] += (isset($amount[$value]['giro']['BCA1']))			? $amount[$value]['giro']['BCA1']		: 0;
	$total[21] += (isset($amount[$value]['giro']['BII2']))			? $amount[$value]['giro']['BII2']		: 0;
	$total[22] += (isset($amount[$value]['giro']['BII3']))			? $amount[$value]['giro']['BII3']		: 0;
	$total[23] += (isset($amount[$value]['giro']['DANAMON']))		? $amount[$value]['giro']['DANAMON']		: 0;
	$total[24] += (isset($amount[$value]['giro']['DANAMON2']))		? $amount[$value]['giro']['DANAMON2']		: 0;
	$total[25] += (isset($amount[$value]['giro']['DANAMON3']))		? $amount[$value]['giro']['DANAMON3']		: 0;
	$total[26] += (isset($amount[$value]['giro']['BNIS']))			? $amount[$value]['giro']['BNIS']		: 0;
	$total[27] += $t_total;
...
for($i=1; $i<27; $i++) cell(number_format((double)$total[$i]), ' align="right" style="color:brown; background-color:lightyellow"');
cell(number_format((double)$total[27]), ' rowspan="2" align="right" style="color:brown; background-color:lightyellow"');
print "</tr>\n";

print "<tr>\n";
cell(number_format((double)$total[1]+$total[2]+$total[3]+$total[4]+$total[5]+$total[6]+$total[7]+$total[8]), ' colspan="8" align="center" style="color:brown; background-color:lightyellow"');
cell(number_format((double)$total[9]+$total[10]+$total[11]+$total[12]+$total[13]+$total[14]+$total[15]+$total[16]+$total[17]+$total[18]), ' colspan="10" align="center" style="color:brown; background-color:lightyellow"');
cell(number_format((double)$total[19]+$total[20]+$total[21]+$total[22]+$total[23]+$total[24]+$total[25]+$total[26]), ' colspan="8" align="center" style="color:brown; background-color:lightyellow"');
print "</tr>\n";
