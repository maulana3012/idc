...
switch (ZKP_URL) {
	...
	case "ALL":
		...
		if($_chk_company == 'off') {
			$tmp_bill[0][]	= "b.bill_ship_to NOT IN ('6IDC', '0MSD', '0SMD')";
			$tmp_turn[0][]	= "t.turn_ship_to NOT IN ('6IDC', '0MSD', '0SMD')";
			$tmp_sv[0][]		= "sv_code NOT IN ('6IDC', '0MSD', '0SMD')";
			$tmp_paid[0][]	= "bill_ship_to NOT IN ('6IDC', '0MSD', '0SMD')";
			$tmp_svpay[0][]	= "sv_code NOT IN ('6IDC', '0MSD', '0SMD')";
			$tmp_bill[1][]	= "b.bill_ship_to NOT IN ('6IDC', '0MSD', '0SMD')";
			$tmp_turn[1][]	= "t.turn_ship_to NOT IN ('6IDC', '0MSD', '0SMD')";
			$tmp_sv[1][]		= "sv_code NOT IN ('6IDC', '0MSD', '0SMD')";
			$tmp_paid[1][]	= "bill_ship_to NOT IN ('6IDC', '0MSD', '0SMD')";
			$tmp_svpay[1][]	= "sv_code NOT IN ('6IDC', '0MSD', '0SMD')";
		}
