...
for($i=0; $i<2; $i++) {
	...
	SELECT
	  ...
	  END AS invoice_source,
	  CASE
		WHEN t.turn_ordered_by = 1 AND '".$db[$i]."' = 'idc' AND t.turn_dept = 'A' THEN 'http://192.168.10.88/idc/apotik/billing/revise_billing.php?_code='||turn_code
		WHEN t.turn_ordered_by = 1 AND '".$db[$i]."' = 'idc' AND t.turn_dept = 'D' THEN 'http://192.168.10.88/idc/dealer/billing/revise_billing.php?_code='||turn_code
		WHEN t.turn_ordered_by = 1 AND '".$db[$i]."' = 'idc' AND t.turn_dept = 'H' THEN 'http://192.168.10.88/idc/hospital/billing/revise_billing.php?_code='||turn_code
		WHEN t.turn_ordered_by = 1 AND '".$db[$i]."' = 'idc' AND t.turn_dept = 'M' THEN 'http://192.168.10.88/idc/marketing/billing/revise_billing.php?_code='||turn_code
		WHEN t.turn_ordered_by = 1 AND '".$db[$i]."' = 'idc' AND t.turn_dept = 'P' THEN 'http://192.168.10.88/idc/pharmaceutical/billing/revise_billing.php?_code='||turn_code
		WHEN t.turn_ordered_by = 1 AND '".$db[$i]."' = 'idc' AND t.turn_dept = 'T' THEN 'http://192.168.10.88/idc/tender/billing/revise_billing.php?_code='||turn_code
		WHEN t.turn_ordered_by = 2 AND '".$db[$i]."' = 'idc' AND t.turn_dept = 'A' THEN 'http://192.168.10.88/mep/apotik/billing/revise_billing.php?_code='||turn_code
		WHEN t.turn_ordered_by = 2 AND '".$db[$i]."' = 'idc' AND t.turn_dept = 'D' THEN 'http://192.168.10.88/mep/dealer/billing/revise_billing.php?_code='||turn_code
		WHEN t.turn_ordered_by = 2 AND '".$db[$i]."' = 'idc' AND t.turn_dept = 'H' THEN 'http://192.168.10.88/mep/hospital/billing/revise_billing.php?_code='||turn_code
		WHEN t.turn_ordered_by = 2 AND '".$db[$i]."' = 'idc' AND t.turn_dept = 'M' THEN 'http://192.168.10.88/mep/marketing/billing/revise_billing.php?_code='||turn_code
		WHEN t.turn_ordered_by = 2 AND '".$db[$i]."' = 'idc' AND t.turn_dept = 'P' THEN 'http://192.168.10.88/mep/pharmaceutical/billing/revise_billing.php?_code='||turn_code
		WHEN t.turn_ordered_by = 2 AND '".$db[$i]."' = 'idc' AND t.turn_dept = 'T' THEN 'http://192.168.10.88/mep/tender/billing/revise_billing.php?_code='||turn_code
		WHEN t.turn_ordered_by = 1 AND '".$db[$i]."' = 'med' AND t.turn_dept = 'A' THEN 'http://192.168.10.88/med/apotik/billing/revise_billing.php?_code='||turn_code
		WHEN t.turn_ordered_by = 1 AND '".$db[$i]."' = 'med' AND t.turn_dept = 'D' THEN 'http://192.168.10.88/med/dealer/billing/revise_billing.php?_code='||turn_code
		WHEN t.turn_ordered_by = 1 AND '".$db[$i]."' = 'med' AND t.turn_dept = 'H' THEN 'http://192.168.10.88/med/hospital/billing/revise_billing.php?_code='||turn_code
		WHEN t.turn_ordered_by = 1 AND '".$db[$i]."' = 'med' AND t.turn_dept = 'M' THEN 'http://192.168.10.88/med/marketing/billing/revise_billing.php?_code='||turn_code
		WHEN t.turn_ordered_by = 1 AND '".$db[$i]."' = 'med' AND t.turn_dept = 'P' THEN 'http://192.168.10.88/med/pharmaceutical/billing/revise_billing.php?_code='||turn_code
		WHEN t.turn_ordered_by = 1 AND '".$db[$i]."' = 'med' AND t.turn_dept = 'T' THEN 'http://192.168.10.88/med/tender/billing/revise_billing.php?_code='||turn_code
	  END AS go_page
	FROM
	  ".$db[$i]."_tb_customer AS c
	...
	SELECT
	  ...
	  END AS invoice_source,
	  CASE
		WHEN b.dr_ordered_by = 1 AND '".$db[$i]."' = 'idc' AND b.dr_dept = 'A' THEN 'http://192.168.10.88/idc/apotik/billing/revise_billing.php?_code='||dr_code
		WHEN b.dr_ordered_by = 1 AND '".$db[$i]."' = 'idc' AND b.dr_dept = 'D' THEN 'http://192.168.10.88/idc/dealer/billing/revise_billing.php?_code='||dr_code
		WHEN b.dr_ordered_by = 1 AND '".$db[$i]."' = 'idc' AND b.dr_dept = 'H' THEN 'http://192.168.10.88/idc/hospital/billing/revise_billing.php?_code='||dr_code
		WHEN b.dr_ordered_by = 1 AND '".$db[$i]."' = 'idc' AND b.dr_dept = 'M' THEN 'http://192.168.10.88/idc/marketing/billing/revise_billing.php?_code='||dr_code
		WHEN b.dr_ordered_by = 1 AND '".$db[$i]."' = 'idc' AND b.dr_dept = 'P' THEN 'http://192.168.10.88/idc/pharmaceutical/billing/revise_billing.php?_code='||dr_code
		WHEN b.dr_ordered_by = 1 AND '".$db[$i]."' = 'idc' AND b.dr_dept = 'T' THEN 'http://192.168.10.88/idc/tender/billing/revise_billing.php?_code='||dr_code
		WHEN b.dr_ordered_by = 2 AND '".$db[$i]."' = 'mep' AND b.dr_dept = 'A' THEN 'http://192.168.10.88/mep/apotik/billing/revise_billing.php?_code='||dr_code
		WHEN b.dr_ordered_by = 2 AND '".$db[$i]."' = 'mep' AND b.dr_dept = 'D' THEN 'http://192.168.10.88/mep/dealer/billing/revise_billing.php?_code='||dr_code
		WHEN b.dr_ordered_by = 2 AND '".$db[$i]."' = 'mep' AND b.dr_dept = 'H' THEN 'http://192.168.10.88/mep/hospital/billing/revise_billing.php?_code='||dr_code
		WHEN b.dr_ordered_by = 2 AND '".$db[$i]."' = 'mep' AND b.dr_dept = 'M' THEN 'http://192.168.10.88/mep/marketing/billing/revise_billing.php?_code='||dr_code
		WHEN b.dr_ordered_by = 2 AND '".$db[$i]."' = 'mep' AND b.dr_dept = 'P' THEN 'http://192.168.10.88/mep/pharmaceutical/billing/revise_billing.php?_code='||dr_code
		WHEN b.dr_ordered_by = 2 AND '".$db[$i]."' = 'mep' AND b.dr_dept = 'T' THEN 'http://192.168.10.88/mep/tender/billing/revise_billing.php?_code='||dr_code
		WHEN b.dr_ordered_by = 1 AND '".$db[$i]."' = 'med' AND b.dr_dept = 'A' THEN 'http://192.168.10.88/med/apotik/billing/revise_billing.php?_code='||dr_code
		WHEN b.dr_ordered_by = 1 AND '".$db[$i]."' = 'med' AND b.dr_dept = 'D' THEN 'http://192.168.10.88/med/dealer/billing/revise_billing.php?_code='||dr_code
		WHEN b.dr_ordered_by = 1 AND '".$db[$i]."' = 'med' AND b.dr_dept = 'H' THEN 'http://192.168.10.88/med/hospital/billing/revise_billing.php?_code='||dr_code
		WHEN b.dr_ordered_by = 1 AND '".$db[$i]."' = 'med' AND b.dr_dept = 'M' THEN 'http://192.168.10.88/med/marketing/billing/revise_billing.php?_code='||dr_code
		WHEN b.dr_ordered_by = 1 AND '".$db[$i]."' = 'med' AND b.dr_dept = 'P' THEN 'http://192.168.10.88/med/pharmaceutical/billing/revise_billing.php?_code='||dr_code
		WHEN b.dr_ordered_by = 1 AND '".$db[$i]."' = 'med' AND b.dr_dept = 'T' THEN 'http://192.168.10.88/med/tender/billing/revise_billing.php?_code='||dr_code
	  END AS go_page
	FROM
	  ".$db[$i]."_tb_customer AS c
