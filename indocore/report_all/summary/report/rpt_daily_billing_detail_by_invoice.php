...
$doc = array(
	"BN"=> "[BN] Medisindo Non Pajak", 
	"BO"=>"[BO] Medisindo Pajak", 
	"DR"=>"[DR] DO Replace", 
	"RR"=>"[RR] Return Replace", 
	"RF"=>"[RF] Return Pajak", 
	"RN"=>"[RN] Return Non Pajak",
	"SO"=>"[SO] Samudia Pajak");
...
include "rpt_daily_billing_detail_by_invoice_print_1.php";
include "rpt_daily_billing_detail_by_invoice_print_2.php";
include "rpt_daily_billing_detail_by_invoice_print_3.php";
?>