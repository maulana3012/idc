...
?>
<h3>[<font color="#446fbe">GENERAL</font>] BILLING SUMMARY by group</h3>
...
<div align="right">
	...
	<a href="<?php echo HTTP_DIR ."$currentDept/$moduleDept/" ?>daily_billing_by_invoice.php?<?php echo getQueryString()?>">View By Invoice</a>
</div><br />
