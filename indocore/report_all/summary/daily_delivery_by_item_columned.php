...
//VARIABLE
$_order_by	= isset($_GET['cboFilterOrderBy']) ? $_GET['cboFilterOrderBy'] : "idc";
...
if(isset($_GET['lastCategoryNo']) && $_GET['lastCategoryNo'] > 0) {
	...
	if(isZKError($path = executeSP($_order_by."_getCategoryPath", $_last_category))) {
...
<table width="100%" class="table_layout">
	<tr>
    	<td width="80%" rowspan="2"><strong class="title">[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] OUTGOING SUMMARY by item<br /><br /></strong></td>
        <td> WAREHOUSE </td>
		<td> SOURCE </td>
    </tr>
    <tr>
    	<td>
			<select name="cboFilterOrderBy">
				<option value="idc">INDOCORE</option>
                <option value="med">MEDISINDO</option>
			</select>
        </td>
		<td>
...
<script language="javascript1.2" type="text/javascript">
	...
	setSelect(f.cboFilterOrderBy, "<?php echo isset($_GET['cboFilterOrderBy']) ? $_GET['cboFilterOrderBy'] : "idc"?>");
...
?>
	...
	f.cboFilterOrderBy.onchange = f.cboFilterSource.onchange;
