...
switch (ZKP_URL) {
	...
	case "ALL":
		...
		if ($_cug_code != 'all') {
			...
			$sql_return[1]	= " SELECT (SELECT cug_name FROM med_tb_customer_group WHERE cug_code = '$_cug_code') AS cug_name,";
			$sql_dr[1]		= " SELECT (SELECT cug_name FROM med_tb_customer_group WHERE cug_code = '$_cug_code') AS cug_name,";
		} else {
			$sql_bill[0] = "
			SELECT
			...
			$sql_bill[1] = "
			SELECT
				COALESCE((SELECT cug_name FROM idc_tb_customer JOIN med_tb_customer_group USING (cug_code) WHERE cus_code = bill_ship_to),
				'Others') AS cug_name,";
			$sql_return[1] = "
			SELECT
				COALESCE((SELECT cug_name FROM idc_tb_customer JOIN med_tb_customer_group USING (cug_code) WHERE cus_code = turn_ship_to),
				'Others') AS cug_name,";
			$sql_dr[1] = "
			SELECT
				COALESCE((SELECT cug_name FROM idc_tb_customer JOIN med_tb_customer_group USING (cug_code) WHERE cus_code = dr_ship_to),
				'Others') AS cug_name,";
		}
	...
	case "MED":
		...
		if ($_cug_code != 'all') {
			...
			$tmp_turn[1][]	= "turn_ship_to IN (SELECT cus_code FROM med_tb_customer WHERE cug_code = '$_cug_code')";
			$tmp_dr[1][]	= "dr_ship_to IN (SELECT cus_code FROM med_tb_customer WHERE cug_code = '$_cug_code')";
			$sql_bill[0] 	= " SELECT (SELECT cug_name FROM med_tb_customer_group WHERE cug_code = '$_cug_code') AS cug_name,";
			$sql_return[0]	= " SELECT (SELECT cug_name FROM med_tb_customer_group WHERE cug_code = '$_cug_code') AS cug_name,";
			$sql_dr[0]		= " SELECT (SELECT cug_name FROM med_tb_customer_group WHERE cug_code = '$_cug_code') AS cug_name,";
		} else {
			$sql_bill[0] = "
			SELECT
