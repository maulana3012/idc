...
switch (ZKP_URL) {
	...
	case "ALL":
		...
		if($_chk_company == 'off') {
			...
			$tmpbill_item[0][]	= "bill_ship_to NOT IN ('0MDS', '0SMD')";
			$tmpturn_item[0][]	= "turn_ship_to NOT IN ('0MDS', '0SMD')";
			$tmpdr_item[0][]	= "dr_ship_to NOT IN ('0MDS', '0SMD')";
			$tmpbill_item[1][]	= "bill_ship_to NOT IN ('6IDC', '0MDS', '0SMD')";
			$tmpturn_item[1][]	= "turn_ship_to NOT IN ('6IDC', '0MDS', '0SMD')";
			$tmpdr_item[1][]	= "dr_ship_to NOT IN ('6IDC', '0MDS', '0SMD')";
		}
