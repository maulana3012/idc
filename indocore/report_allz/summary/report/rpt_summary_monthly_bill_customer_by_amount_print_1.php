...
switch (ZKP_URL) {
	...
	case "ALL":
		...
		if($_chk_company == 'off') {
			...
			$tmp_sl[0][]		= "bill_ship_to NOT IN ('0MDS', '0SMD')";
			$tmp_turn[0][]		= "turn_ship_to NOT IN ('0MDS', '0SMD')";
			$tmp_bill[1][]		= "bill_ship_to NOT IN ('6IDC', '0MDS', '0SMD')";
			$tmp_sl[1][]		= "bill_ship_to NOT IN ('6IDC', '0MDS', '0SMD')";
			$tmp_turn[1][]		= "turn_ship_to NOT IN ('6IDC', '0MDS', '0SMD')";
			$tmp_bill_month[0][]	= "bill_ship_to NOT IN ('0MDS', '0SMD')";
			$tmp_sl_month[0][]	= "bill_ship_to NOT IN ('0MDS', '0SMD')";
			$tmp_turn_month[0][]	= "turn_ship_to NOT IN ('0MDS', '0SMD')";
			$tmp_bill_month[1][]	= "bill_ship_to NOT IN ('6IDC', '0MDS', '0SMD')";
			$tmp_sl_month[1][]	= "bill_ship_to NOT IN ('6IDC', '0MDS', '0SMD')";
			$tmp_turn_month[1][]	= "turn_ship_to NOT IN ('6IDC', '0MDS', '0SMD')";
		}
