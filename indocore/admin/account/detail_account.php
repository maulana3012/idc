...
$part = array('IDC', 'MEP', 'MED', 'SMD', 'ALL');
...
<table width="100%" class="table_l" cellspacing="1">
	...
	<tr>
		...
		<td>
			...
			<input type="checkbox" name="_auth[]" value="16"<?php echo ($data['ma_authority'] & 16) ? ' checked':'' ?>> Unconfirm PO &nbsp;
		</td>
	</tr>
	<tr>
		<th>WAREHOUSE</th>
...
<table width="100%" class="table_box">
		...
		<th width="15%" rowspan="5">GRADE</th>
		<td width="10%">ALL</td>
		<td>
	...
	<tr>
		<td>SAMUDIA</td>
		<td>
			<input type="radio" name="_gr_grade_smd" value="true"<?php echo ($data["ma_is_manager_smd"]=="t") ? " checked":"" ?>> General Manager &nbsp;
			<input type="radio" name="_gr_grade_smd" value="false"<?php echo ($data["ma_is_manager_smd"]=="f") ? " checked":"" ?>> Admin
		</td>
	</tr>
</table>
<table width="100%" class="table_l">
	<tr height="20px">
		...
		<th colspan="4">SMD</th><th width="5%">&nbsp;</th>
...
<table width="100%" cellpadding="0" cellspacing="2" border="0">
	<tr>
	    	<td>Note : <i>Inquiry, Input, Update, Delete</i></td>
		<td align="right">
