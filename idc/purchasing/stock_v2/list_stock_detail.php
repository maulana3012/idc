...
<table width="100%" class="table_box">
	<tr>
		<td><h4>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] DETAIL STOCK</h4></td>
	</tr>
	<tr>
...
<?php require_once APP_DIR . "_include/purchasing/report/$moduleDept/rpt_list_stock_detail.php" ?><br />
