...
<form name="frmUpdate" method="POST" action="<?php echo $_SERVER['PHP_SELF'].'?'.getQueryString() ?>">
...
<table width="100%" class="table_c">
	...
	<tr>
		...
		<td align="right"><?php echo number_format((int)$column['it_available_stock'],2)?></td>
		<td align="right"><font color="<?php echo $column['it_color'] ?>"><?php echo ($column['it_diff']<=0) ? number_format($column['it_diff']*-1,2) : number_format($column['it_diff'],2)?></font></td>
	</tr>
	<?php } ?>
</table>
</form>
