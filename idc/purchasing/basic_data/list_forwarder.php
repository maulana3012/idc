...
* @author : daesung kim
*
* $Id: list_forwarder.php,v 1.1 2008/04/28 06:52:13 neki Exp $
*/
//REQUIRE
...
//DEFAULT PROCESS
$sqlQuery = new strSelect("SELECT fw_code, fw_full_name, substr(fw_address,0,40) AS fw_address, fw_phone, fw_fax FROM ".ZKP_SQL."_tb_forwarder");
...
<table width="100%" class="table_no_02">
	<tr>
		<td width="70%"><h4>[<font color="blue"><?php echo strtoupper($currentDept) ?></font>] FORWARDER LIST</h4></td>
		<td>
...
?>
	<tr>
		...
		<td><?php echo $column['fw_code'];?></td>
		<td>
			<a href="detail_forwarder.php?_code=<?php echo $column['fw_code']?>" style="color:darkblue">
				<?php echo $column['fw_full_name'];?>
			</a>
		</td>
		<td><?php echo $column['fw_phone'];?></td>
		<td><?php echo $column['fw_fax'];?></td>
		<td><?php echo $column['fw_address'];?></td>
	</tr>
<?php
}//end repeat rows
?>
