...
//DEFAULT PROCESS
$sql	= "SELECT * FROM ".ZKP_SQL."_tb_pl AS pl JOIN ".ZKP_SQL."_tb_in_pl AS inpl USING(pl_idx) WHERE pl.pl_idx = $_code AND inpl.inpl_idx = $_inpl_idx";
$result = query($sql);
...
WHERE init.inpl_idx = $_inpl_idx AND init_qty > 0
ORDER BY it.it_code
";
...
<table width="100%" class="table_box">
	<tr>
		...
		<td colspan="2" align="right"><i>Inputed by: <?php echo $column["inpl_created_by_account"] . date(', j-M-Y g:i:s', strtotime($column["inpl_created_timestamp"]))?></i></td>
	</tr>
	<tr>
...
<table width="100%" class="table_box">
	...
	<tr>
		<th>REMARK</th>
		<td colspan="3"><textarea name="_remark" style="width:100%" rows="3" readonly><?php echo $column["inpl_remark"] ?></textarea></td>
	</tr>
</table><br />
