...
?>
<h4>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] OUTSTANDING PL by supplier</h4>
...
<?php require_once APP_DIR . "_include/purchasing/report/packing_list/rpt_summary_outstanding_by_supplier.php" ?>
