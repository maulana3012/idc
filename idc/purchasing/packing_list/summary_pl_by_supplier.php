...
?>
<h4>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] PL SUMMARY by supplier</h4>
...
<table width="100%" class="table_box">
	<tr>
		<td align="right">
			<a href="<?php echo HTTP_DIR ."purchasing/packing_list/" ?>summary_pl_by_item.php?<?php echo getQueryString()?>">View By Item</a>
		</td>
	</tr>
</table>
<?php require_once APP_DIR . "_include/purchasing/report/packing_list/rpt_summary_pl_by_supplier.php" ?>
