...
<table width="100%" class="table_layout">
	<tr>
		<td width="80%" rowspan="2"><h3>[<font color="#446fbe">GENERAL</font>] DEBIT SUMMARY by group</h3></td>
		<td> ORDER BY </td>
		<td> MARKETING </td>
	</tr>
	<tr>
...
<?php require_once APP_DIR . "_include/purchasing/report/summary/rpt_debit_by_group.php" ?>
