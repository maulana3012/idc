...
$_order_by	= isset($_GET['cboFilterOrder']) ? $_GET['cboFilterOrder'] : "1";
...
<table width="100%" class="table_layout">
	<tr>
		<td width="80%" rowspan="2"><h3>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] DELIVERY SUMMARY by item</h3></td>
		<td> ORDER BY </td>
		<td> MARKETING </td>
	</tr>
	<tr>
...
<?php require_once APP_DIR . "_include/purchasing/report/summary/rpt_delivery_by_item.php" ?>
