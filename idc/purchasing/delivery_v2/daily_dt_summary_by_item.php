...
//Global
$left_loc 	  = "daily_dt_summary_by_item.php";
?>
<html>
<head>
...
?>
<strong class="title">[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] NON ORDER SUMMARY by item<br /><br /></strong>
...
<table width="100%" class="table_box">
	<tr>
		<td align="right">
			<a href="./daily_dt_summary_by_group.php?<?php echo getQueryString()?>">View By Group</a>
		</td>
	</tr>
</table>
<?php require_once APP_DIR . "_include/warehouse/report/delivery_v2/rpt_dt_summary_by_item.php" ?>
