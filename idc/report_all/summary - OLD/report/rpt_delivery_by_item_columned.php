...
FROM ".$db."_tb_outgoing JOIN ".$db."_tb_outgoing_item USING(out_idx) 
...
FROM ".$db."_tb_incoming JOIN ".$db."_tb_incoming_item USING(inc_idx)
...
FROM ".$db."_tb_item_cat AS a JOIN ".$db."_tb_item AS b USING(icat_midx) 
WHERE $strWhereItem
