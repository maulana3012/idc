...
<small>* Inventory information in apotik [<?php echo $_cus_code?>] <?php echo $_cus_name ?></small>
</strong>
<hr>
...
<tr>
	...
	<th width="15%">
		...
		<a href="javascript:document.location.href='p_list_item_3.php?_cus_code=<?php echo $_cus_code?>&_cus_name=<?php echo $_cus_name?>'"><img src="../../_images/icon/list_mini.gif" alt="Show all item"></a>&nbsp;
	</th>
</tr>
</table><br />
<script language="javascript" type="text/javascript">
function searchByCat() {
	...
	for (var i = 2; i >=0; i--) {
		if (o[i].value != 0) {
			window.location.href = "?lastCategoryNo=" + o[i].value + "&_cus_code=<?php echo $_cus_code?>&_cus_name=<?php echo $_cus_name?>";
			break;
		}
	}
}
...
<table width="100%" class="table_box">
  <tr>
	...
	<th>ITEM NO</th>
	<th width="16%" rowspan="2">@PRICE</th>
	<th width="5%" rowspan="2">JK<br></th>
	<th width="12%">STOCK<br />APOTIK</th>
  	<th width="10%">LAST SALES</th>
	<th width="12%" rowspan="2">EST/<br>SALES</th>
	<th width="12%" rowspan="2">EST/<br>STOCK</th>
  </tr>
</table>
<div style="height:340; overflow-y:scroll">
...
?>
	<tr>
		...
		<td width="7%"><a href="javascript:fillItem('<?php echo $column['it_code'];?>')"><?php echo $column['it_code']?></a></td>
		<td width="13%"><?php echo cut_string($column['it_model_no'], 10)?></td>
		<td align="right" width="12%"><?php echo "Rp. ". number_format((double)$column['user_price'])?></td>
		<td align="right" width="8%"><?php echo number_format((double)$column['inv_jk'])?></td>
		<td align="right" width="8%"><?php echo number_format((double)$column['r_stock'])?></td>
	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<input type="hidden" name="_it_desc">
			</td>
			...
			<td><input type="text" name="_it_delivery" style="width:100%" class="reqd" onKeyPress="if(window.event.keyCode == 13) createNewItem()"></td>
