...
$_filter_date	= isset($_GET['cboFilterDate']) ? $_GET['cboFilterDate'] : "due";
...
<table width="100%" class="table_layout">
	<tr>
		<td width="90%" rowspan="2"><h3>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] DEBIT SUMMARY by due date</h3></td>
...
<?php require_once APP_DIR . "_include/billing/report/rpt_debit_by_due_date.php" ?>
<script language="javascript1.2" type="text/javascript">
	...
	setSelect(f.cboFilterDate, "<?php echo isset($_GET['cboFilterDate']) ? $_GET['cboFilterDate'] : "due"?>");
	...
	f.cboFilterDate.onchange		= f._cug_code.onchange;
