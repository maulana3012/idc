...
//GLOBAL
$left_loc = "sales_summary_by_group.php";
...
<table width="100%" class="table_layout">
	<tr>
		<td width="70%" rowspan="2"><h3>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] SALES SUMMARY BY group</h3></td>
		<td>CATEGORY</td>
	</tr>
	<tr>
		<td>
...
<table width="100%" class="table_box">
	<tr>
		<td align="right">
			<a href="<?php echo HTTP_DIR . "$currentDept/$moduleDept/" ?>sales_summary_by_item.php?<?php echo getQueryString()?>">View By Item</a>
		</td>
	</tr>
</table><br />
<?php require_once APP_DIR . "_include/order/report/rpt_sales_summary_by_group.php" ?>
