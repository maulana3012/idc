...
<!--START: BODY-->
<strong>DETAIL PAYMENT</strong><br /><br />
<table width="100%" class="table_box">
	<tr>
		<th width="25%">BILL CODE</th>
		<td><?php echo $column['bill_code'] ?></td>
...
<table width="100%" class="table_box">
	<tr>
		<td><button name="btnDelete" class="input_sky" onClick="checkform(window.document.frmPayment)">DELETE</button></td>
		<td align="right"><button name="btnClose" class="input_sky" onClick="window.close()">CLOSE</button></td>
	</tr>
</table>
<!--END: BODY-->
</body>
