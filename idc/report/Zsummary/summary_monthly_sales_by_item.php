...
if($currentDept == 'apotik' || $currentDept == 'report') $remark = "*) Based on Sales Report, Billing Issue Item, Return Item";
else						 $remark = "*) Based on Billing Issue Item, Return Item";
