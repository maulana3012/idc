...
if(ZKP_FUNCTION == 'ALL') {
	if($_order_by == 1) {
		$tmp_billing1[] = "SUBSTR(bill_code,1,1) IN ('I','M')";
		$tmp_billing2[] = "SUBSTR(bill_code,1,1) IN ('I','M')";
	} else if($_order_by == 2) {
	...
	if($cboFilter[1][ZKP_URL][0][0] == 1) {
		$tmp_billing1[] = "SUBSTR(bill_code,1,1) IN ('I','M') AND ".ZKP_SQL."_isValidShowInvoice('".ZKP_URL."', bill_code,'billing')";
		$tmp_billing2[] = "SUBSTR(bill_code,1,1) IN ('I','M') AND ".ZKP_SQL."_isValidShowInvoice('".ZKP_URL."', bill_code,'billing')";
