...
/*
$tmp['bill'][] = "bill_code = 'BO-00022H-A13'";
$tmp['turn'][] = "turn_bill_code = 'BO-00022H-A13'";
$tmp['pay'][]  = "bill_code = 'BO-00022H-A13'";
*/
...
UNION
  ...
  WHERE ".$strWhere['pay']."
  ORDER BY reference, date, sort_order, condition, code
";
...
// Count saldo saat ini
$rdIdx	= 0;
foreach($group0 as $val) {
	if(strtotime($rd[$rdIdx][4]) >= strtotime($period_from) &&  
		strtotime($rd[$rdIdx][4]) <= strtotime($period_to) && 
		$rd[$rdIdx][5] != "bill_freight") {
