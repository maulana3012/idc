...
$doc = array(
		'out' => array(1=>'DO Billing', 2=>'DO Order', 3=>'DT', 4=>'DF', 5=>'DR', 6=>'DM'),
		'in' => array(1=>'Return Billing', 2=>'Return order', 3=>'Return DT')
	);
...
$tmp_out2_month	= array();
$tmp_inc1_month	= array();
$tmp_inc2_month	= array();
...
if($_inc_med == '') {
	$tmp_out1[]	= "cus_code NOT IN ('0MSD', '0SMD')";
	$tmp_out2[]	= "cus_code NOT IN ('0MSD', '0SMD')";
	$tmp_inc1[]	= "cus_code NOT IN ('0MSD', '0SMD')";
	$tmp_inc2[]	= "cus_code NOT IN ('0MSD', '0SMD')";
	$tmp_out1_month[]	= "cus_code NOT IN ('0MSD', '0SMD')";
	$tmp_out2_month[]	= "cus_code NOT IN ('0MSD', '0SMD')";
	$tmp_inc1_month[]	= "cus_code NOT IN ('0MSD', '0SMD')";
	$tmp_inc2_month[]	= "cus_code NOT IN ('0MSD', '0SMD')";
}

if($_cus_code != '') {
	$tmp_out1[] 	= "cus_code = '$_cus_code'";
	$tmp_out2[] 	= "cus_code = '$_cus_code'";
	$tmp_inc1[]	= "cus_code = '$_cus_code'";
	$tmp_inc2[]	= "cus_code = '$_cus_code'";
	$tmp_rjt1[]	= "rjit_idx is null";
	$tmp_rjt2[]	= "rjed_idx is null";
	$tmp_out1_month[]	= "cus_code = '$_cus_code'";
	$tmp_out2_month[]	= "cus_code = '$_cus_code'";
	$tmp_inc1_month[]	= "cus_code = '$_cus_code'";
	$tmp_inc2_month[]	= "cus_code = '$_cus_code'";
	$tmp_rjt1_month[]	= "rjit_idx is null";
	$tmp_rjt2_month[]	= "rjed_idx is null";
}

if($_cug_code != 'all') {
	$tmp_out1[]	= "cus_code IN (SELECT cus_code FROM ".$db."_tb_customer WHERE cug_code = '$_cug_code')";
	$tmp_out2[]	= "cus_code IN (SELECT cus_code FROM ".$db."_tb_customer WHERE cug_code = '$_cug_code')";
	$tmp_inc1[]	= "cus_code IN (SELECT cus_code FROM ".$db."_tb_customer WHERE cug_code = '$_cug_code')";
	$tmp_inc2[]	= "cus_code IN (SELECT cus_code FROM ".$db."_tb_customer WHERE cug_code = '$_cug_code')";
	$tmp_rjt1[]	= "rjit_idx is null";
	$tmp_rjt2[]	= "rjed_idx is null";
	$tmp_out1_month[]	= "cus_code IN (SELECT cus_code FROM ".$db."_tb_customer WHERE cug_code = '$_cug_code')";
	$tmp_out2_month[]	= "cus_code IN (SELECT cus_code FROM ".$db."_tb_customer WHERE cug_code = '$_cug_code')";
	$tmp_inc1_month[]	= "cus_code IN (SELECT cus_code FROM ".$db."_tb_customer WHERE cug_code = '$_cug_code')";
	$tmp_inc2_month[]	= "cus_code IN (SELECT cus_code FROM ".$db."_tb_customer WHERE cug_code = '$_cug_code')";
	$tmp_rjt1_month[]	= "rjit_idx is null";
	$tmp_rjt2_month[]	= "rjed_idx is null";
}
...
if(substr($_filter_doc,0,3) == 'out') {
	if($_filter_doc == 'out') {
		$tmp_inc1[]	= "inc_idx is null";
		$tmp_inc2[]	= "inc_idx is null";
		$tmp_inc1_month[]	= "inc_idx is null";
		$tmp_inc2_month[]	= "inc_idx is null";
	} else if($_filter_doc == 'out-7') {
		$tmp_out1[]	= "out_idx is null";
		$tmp_out2[]	= "out_idx is null";
		$tmp_inc1[]	= "inc_idx is null";
		$tmp_inc2[]	= "inc_idx is null";
		$tmp_out1_month[]	= "out_idx is null";
		$tmp_out2_month[]	= "out_idx is null";
		$tmp_inc1_month[]	= "inc_idx is null";
		$tmp_inc2_month[]	= "inc_idx is null";
	} else {
		$tmp_out1[]	= "out_doc_type = ". substr($_filter_doc,4,1);
		$tmp_out2[]	= "out_doc_type = '". $doc['out'][substr($_filter_doc,4,1)] . "'";
		$tmp_inc1[]	= "inc_idx is null";
		$tmp_inc2[]	= "inc_idx is null";
		$tmp_rjt1[]	= "rjit_idx is null";
		$tmp_rjt2[]	= "rjed_idx is null";
		$tmp_out1_month[]	= "out_doc_type = ". substr($_filter_doc,4,1);
		$tmp_out2_month[]	= "out_doc_type = '". $doc['out'][substr($_filter_doc,4,1)] . "'";
		$tmp_inc1_month[]	= "inc_idx is null";
		$tmp_inc2_month[]	= "inc_idx is null";
		$tmp_rjt1_month[]	= "rjit_idx is null";
		$tmp_rjt2_month[]	= "rjed_idx is null";
	...
	if($_filter_doc == 'in') {
		...
		$tmp_out1[]	= "out_idx is null";
		$tmp_out2[]	= "out_idx is null";
		$tmp_inc1[]	= "inc_doc_type = '". $doc['in'][substr($_filter_doc,3,1)] . "'";
		$tmp_inc2[]	= "inc_doc_type = '". $doc['in'][substr($_filter_doc,3,1)] . "'";
		$tmp_rjt1[]	= "rjit_idx is null";
		$tmp_rjt2[]	= "rjed_idx is null";
		$tmp_inc1_month[]	= "inc_doc_type = '". $doc['in'][substr($_filter_doc,3,1)] . "'";
		$tmp_inc2_month[]	= "inc_doc_type = '". $doc['in'][substr($_filter_doc,3,1)] . "'";
		$tmp_out1_month[]	= "out_idx is null";
		$tmp_out2_month[]	= "out_idx is null";
		$tmp_rjt1_month[]	= "rjit_idx is null";
		$tmp_rjt2_month[]	= "rjed_idx is null";
...
if ($_last_category != 0) {
	...
	$tmp_out2[]	= "icat_midx IN (" . (empty($catList[0]) ? "0" : $catList[0]) . ")";
	$tmp_inc1[]	= "icat_midx IN (" . (empty($catList[0]) ? "0" : $catList[0]) . ")";
	$tmp_inc2[]	= "icat_midx IN (" . (empty($catList[0]) ? "0" : $catList[0]) . ")";
	...
	$tmp_out2_month[]	= "icat_midx IN (" . (empty($catList[0]) ? "0" : $catList[0]) . ")";
	$tmp_inc1_month[]	= "icat_midx IN (" . (empty($catList[0]) ? "0" : $catList[0]) . ")";
	$tmp_inc2_month[]	= "icat_midx IN (" . (empty($catList[0]) ? "0" : $catList[0]) . ")";
...
if($_filter_vat != 'all') {
	...
	$tmp_out2[]	= "out_type = $_filter_vat";
	$tmp_inc1[]	= "inc_type = $_filter_vat";
	$tmp_inc2[]	= "inc_type = $_filter_vat";
	$tmp_rjt1[] = "rjit_type = $_filter_vat";
	$tmp_rjt2[] = "rjed_type = $_filter_vat";
	$tmp_out1_month[]	= "out_type = $_filter_vat";
	$tmp_out2_month[]	= "out_type = $_filter_vat";
	$tmp_inc1_month[]	= "inc_type = $_filter_vat";
	$tmp_inc2_month[]	= "inc_type = $_filter_vat";
...
if($_filter_dept != 'all') {
	...
	$tmp_out2[]	= "out_dept = '$_filter_dept'";
	$tmp_inc1[]	= "inc_dept = '$_filter_dept'";
	$tmp_inc2[]	= "inc_dept = '$_filter_dept'";
	$tmp_rjt1[] = "rjit_idx is null";
	$tmp_rjt2[] = "rjed_idx is null";
	$tmp_out1_month[]	= "out_dept = '$_filter_dept'";
	$tmp_out2_month[]	= "out_dept = '$_filter_dept'";
	$tmp_inc1_month[]	= "inc_dept = '$_filter_dept'";
	$tmp_inc2_month[]	= "inc_dept = '$_filter_dept'";
	$tmp_rjt1_month[]	= "rjit_idx is null";
	$tmp_rjt2_month[]	= "rjed_idx is null";
}
...
$tmp_out2[]	= "out_cfm_date BETWEEN DATE '$period_from 00:00:00' AND '$period_to 23:59:59'";
$tmp_inc1[]	= "inc_confirmed_timestamp BETWEEN DATE '$period_from 00:00:00' AND '$period_to 23:59:59'";
$tmp_inc2[]	= "inc_confirmed_timestamp BETWEEN DATE '$period_from 00:00:00' AND '$period_to 23:59:59'";
...
$tmp_out2_month[]	= "out_cfm_date BETWEEN DATE '$period_from 00:00:00' AND '$period_to 23:59:59'";
$tmp_inc1_month[]	= "inc_confirmed_timestamp BETWEEN DATE '$period_from 23:59:59' AND '$period_to 23:59:59'";
$tmp_inc2_month[]	= "inc_confirmed_timestamp BETWEEN DATE '$period_from 23:59:59' AND '$period_to 23:59:59'";
...
$strWhereOut2  	= implode(" AND ", $tmp_out2);
$strWhereInc1 	= implode(" AND ", $tmp_inc1);
$strWhereInc2 	= implode(" AND ", $tmp_inc2);
$strWhereRjt1	= implode(" AND ", $tmp_rjt1);
$strWhereRjt2	= implode(" AND ", $tmp_rjt2);
$strWhereMonthOut1 	= implode(" AND ", $tmp_out1_month);
$strWhereMonthOut2 	= implode(" AND ", $tmp_out2_month);
$strWhereMonthInc1 	= implode(" AND ", $tmp_inc1_month);
$strWhereMonthInc2 	= implode(" AND ", $tmp_inc2_month);
$strWhereMonthRjt1	= implode(" AND ", $tmp_rjt1_month);
$strWhereMonthRjt2	= implode(" AND ", $tmp_rjt2_month);
/*
echo "<pre>";
var_dump($strWhereMonthOut1, $strWhereMonthOut2);
echo "</pre>";
exit; 
*/
$sql_out = "
...
FROM
  ".$db."_tb_customer
  JOIN ".$db."_tb_outgoing_v2 USING(cus_code)
  JOIN ".$db."_tb_outgoing_stock_v2 USING (out_idx)
  JOIN ".$db."_tb_item USING(it_code)
  JOIN ".$db."_tb_item_cat USING (icat_midx)
WHERE $strWhereOut2
";
...
FROM
  ".$db."_tb_customer
  JOIN ".$db."_tb_incoming USING(cus_code)
  JOIN ".$db."_tb_incoming_stock_v2 USING (inc_idx)
  JOIN ".$db."_tb_item USING(it_code)
  JOIN ".$db."_tb_item_cat USING (icat_midx)
WHERE $strWhereInc2
";
...
$sqlQtyperMonth = "
SELECT a.it_code, to_char(out_cfm_date, 'YYYYMM') AS month, sum(otst_qty) AS qty,'1-1' AS column
  FROM
	".$db."_tb_customer
	JOIN ".$db."_tb_outgoing USING(cus_code)
	JOIN ".$db."_tb_outgoing_stock USING (out_idx)
...
SELECT a.it_code, to_char(out_cfm_date, 'YYYYMM') AS month, sum(otst_qty) AS qty,'1-2' AS column
  FROM
	".$db."_tb_customer
	JOIN ".$db."_tb_outgoing_v2 USING(cus_code)
	JOIN ".$db."_tb_outgoing_stock_v2 USING (out_idx)
	JOIN ".$db."_tb_item AS a USING(it_code)
  WHERE ". $strWhereMonthOut2 ."
  GROUP BY a.it_code, month 

UNION

SELECT a.it_code, to_char(inc_confirmed_timestamp, 'YYYYMM') AS month, sum(inst_qty)*-1 AS qty,'2-1' AS column
  FROM
	".$db."_tb_customer
	JOIN ".$db."_tb_incoming USING(cus_code)
	JOIN ".$db."_tb_incoming_stock USING (inc_idx)
	JOIN ".$db."_tb_item AS a USING(it_code)
  WHERE ". $strWhereMonthInc1 ." 
  GROUP BY a.it_code, month 

UNION

SELECT a.it_code, to_char(inc_confirmed_timestamp, 'YYYYMM') AS month, sum(inst_qty)*-1 AS qty,'2-2' AS column
  FROM
	".$db."_tb_customer
	JOIN ".$db."_tb_incoming USING(cus_code)
	JOIN ".$db."_tb_incoming_stock_v2 USING (inc_idx)
	JOIN ".$db."_tb_item AS a USING(it_code)
  WHERE ". $strWhereMonthInc2 ." 
  GROUP BY a.it_code, month 
