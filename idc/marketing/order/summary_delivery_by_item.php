...
//GLOBAL
$left_loc	  = "summary_delivery_by_item.php";
...
<table width="100%" class="table_layout">
	<tr>
		<td width="90%" rowspan="2"><h4>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] SUMMARY DELIVERY ORDER by item</h4></td>
...
<table width="100%" class="table_box">
	<tr>
		<td align="right">
			<a href="<?php echo HTTP_DIR . "$currentDept/$moduleDept/" ?>summary_delivery_by_group.php?<?php echo getQueryString()?>">View By Group</a>
		</td>
	</tr>
</table>
<?php require_once APP_DIR . "_include/order/report/rpt_summary_delivery_detail_by_item.php" ?>
