...
<table width="100%" class="table_layout">
	<tr>
		<td rowspan="2" width="90%"><h4>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] OUTSTANDING DELIVERY ORDER by item</h4></td>
...
<table width="100%" class="table_box">
	<tr>
		<td align="right">
			<a href="<?php echo HTTP_DIR . "$currentDept/$moduleDept/" ?>summary_outstanding_by_group.php?<?php echo getQueryString()?>">View By Group</a>
		</td>
	</tr>
</table><br />
<?php require_once APP_DIR . "_include/order/report/rpt_summary_outstanding_by_item.php" ?>
...
?>
	...
	f.cboFilterPaper.onchange = function() {
	...
	f.cboFilterOrderBy.onchange		= f.cboFilterPaper.onchange;
