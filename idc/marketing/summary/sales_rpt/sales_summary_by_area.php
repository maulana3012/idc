...
//Global
$left_loc 	  = "sales_summary_by_area.php";
...
<table width="100%" class="table_layout">
	<tr>
		<td width="70%" rowspan="2"><h3>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] SALES SUMMARY BY area</h3></td>
		<td>CATEGORY</td>
	</tr>
	<tr>
		<td>
...
<?php require_once APP_DIR . "_include/order/report/rpt_sales_summary_by_area.php" ?>
