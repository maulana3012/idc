...
ckperm(ZKP_SELECT, HTTP_DIR . "apotik/sales_rpt/index.php");

//GLOBAL
$left_loc = "sales_log_by_item.php";
...
<table width="100%" class="table_layout">
	<tr>
		<td width="70%" rowspan="2"><h3>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] SALES LOG BY ITEM</h3></td>
		<td>CATEGORY</td>
	</tr>
	<tr>
		<td>
...
<table width="100%" class="table_layout">
	...
	<tr>
		<td></td>
		<td><input type="text" name="_cus_code" size="5" class="fmt" onClick="fillCustomer(window.document.frmSearch._cus_code.value)" value="<?php echo $_cus_code?>" readonly></td>
		<td valign="middle">
...
<?php require_once APP_DIR . "_include/order/report/rpt_sales_log_by_item.php" ?>
