...
//Warning
	...
	$pdf->setXY(80, 122);
	$pdf->Cell(70, 5, "PERHATIAN", 1,0,'C');
	$pdf->setXY(80, 127);
	$pdf->setFont('Arial', '', 9);
	$pdf->MultiCell(70, 3.5, "Jika barang tidak diambil dalam waktu jangka 3 bulan maka PT. Indocore Perkasa tidak bertanggung jawab atas hilangnya barang tersebut");
