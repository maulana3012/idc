...
//Global
$left_loc 	  = "summary_finished_service_by_item.php";
  ...
  <tr>
    <td style="padding:0 3 3 3">
        ...
        <tr>
          	...
          	<!--START: BODY-->
<strong class="title">[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] FINISHED SERVICE SUMMARY by item</strong><br /><br />
...
<table width="100%" class="table_box">
	<tr>
		<td align="right">
			<a href="./summary_finished_service_by_customer.php?<?php echo getQueryString()?>">View By Group</a>
		</td>
	</tr>
</table>
<iframe id="rightFrame" src="i_summary_finished_service_by_item.php?<?php echo getQueryString()?>" frameborder="0" width="100%" height="<?php echo $numRow*60+200 ?>px" name="iFrm"></iframe><br /><br />
