...
$_cus_channel	= isset($_REQUEST['_cus_channel'])? $_REQUEST['_cus_channel'] : $_REQUEST['_cus_channel'] = "00S";
$strwhere	= array();
...
<table width="100%" class="table_box">
	<tr>
		...
		<td colspan="2" align="center">
			<select name="_cus_channel" style="width:100%" disabled>
...
<script language="javascript" type="text/javascript">
	window.document.frmSearch._cus_channel.onchange = function() {
		window.location.href = "?_cus_channel=00S";
	}
</script>
<!--END: SEARCH-->
<!--START: LIST-->
