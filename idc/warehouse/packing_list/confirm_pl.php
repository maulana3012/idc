...
//-------------------------------------------------------------------------------------------- DEFAULT PROCESS
$col[0] = getPLConfirm('PL', $_code, '', 'info'); 
$col[1] = getPLConfirm('PL', $_code, '', 'item'); 
$col[2] = getPLConfirm('PL', $_code, '', 'in_item'); 
...
while($col_in =& fetchRowAssoc($col[2])) {
	...
	//1st grouping
	if($cache[0] != $col_in['inpl_idx']) {
		$cache[0] = $col_in['inpl_idx'];
		$group0[$col_in['inpl_idx']] = array();
	}
	...
	$group0[$col_in['inpl_idx']][$col_in['it_code']] = 1;
}
$g_total = 0;
?>
<html>
...
<input type='hidden' name='p_mode' value="confirm_PL">
<input type="hidden" name="_code" value="<?php echo $col[0]['pl_idx']?>">
<input type="hidden" name="_po_code" value="<?php echo $col[0]['po_code']?>">
<input type="hidden" name="_sp_code" value="<?php echo $col[0]['pl_sp_code']?>">
<input type="hidden" name="_pl_type" value="<?php echo $col[0]['pl_type']?>">
<input type="hidden" name="_pl_invoice_no" value="<?php echo $col[0]['pl_inv_no']?>">
<input type="hidden" name="_shipment_mode" value="<?php echo $col[0]['pl_shipment_mode']?>">
	<table width="100%" class="table_box">
		...
		<tr>
			...
			<td width="40%"><span class="bar"><?php echo $col[0]["pl_inv_no"] ?></span></td>
