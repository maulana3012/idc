...
$cat = array("NEW", "PO SUMMARY", "PO BALANCE", "PL SUMMARY");
//------------------------------------------------------------------
...
//------------------------------------------------------------------
$item0[] = "input_po.php::New PO";
$item0[] = "input_pl.php::New PL";
...
$item3[] = "summary_pl_by_item.php::By Item";
$item3[] = "summary_pl_by_supplier.php::By Supplier";
//------------------------------------------------------------------
