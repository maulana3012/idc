...
if($_code != '') {
	$sqlQuery->whereCaluse = "po_confirmed_timestamp is not null and sp_code='$_code'";
} else {
	$sqlQuery->whereCaluse = "po_confirmed_timestamp is not null";
}
$sqlQuery->setOrderBy("po_date DESC, po_code DESC");
...
?>
	  <tr>
		...
		<td width="20%" align="center"><?php echo date('j-M-Y', strtotime($column['po_date']))?></td>
