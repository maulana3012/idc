...
?>
<h3>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] PL SUMMARY by item</h3>
<div align="right">
...
<table width="100%" class="table_box">
	<tr>
		<td align="right">
			<a href="<?php echo HTTP_DIR . "$currentDept/$moduleDept/" ?>summary_pl_by_supplier.php?<?php echo getQueryString()?>">View By Supplier</a>
		</td>
	</tr>
</table>
<?php require_once APP_DIR . "_include/warehouse/report/purchasing/rpt_summary_pl_by_item.php" ?>
