...
<table width="100%" class="table_layout">
	<tr>
		<td width="85%" rowspan="2"><strong class="title">[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] OUTGOING SUMMARY by group<br /><br /></strong></td>
		<td> ORDER BY </td>
		<td> SOURCE </td>
		<td> CATEGORY </td>
	</tr>
...
<?php require_once APP_DIR . "_include/warehouse/report/delivery_v2/rpt_daily_delivery_detail_by_group.php" ?>
