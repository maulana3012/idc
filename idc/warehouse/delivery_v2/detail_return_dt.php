...
<table width="100%" class="table_box">
	<tr>
		...
		<td colspan="2" align="right"><span class="comment"><i>Confirm by : <?php echo $col[0]['inc_confirmed_by_account'].date(', d-M-Y g:i:s',strtotime($col[0]['inc_confirmed_timestamp'])) ?></i></span></td>
	</tr>
	<tr>
		<th width="15%">RETURN NO</th>
		<td width="25%" colspan="2"><b><?php echo $col[0]['inc_doc_ref'] ?></b></td>
		<th width="15%">RETURN DATE</th>
		<td><?php echo date('d-M-Y', strtotime($col[0]['inc_date'])) ?></td>
...
<script language="javascript" type="text/javascript">
	window.document.all.btnList.onclick = function() {
		window.location.href = "daily_return_by_group.php?cboSource=<?php echo $col[0]["inc_doc_type"]?>";
	}
</script>
