...
$sqlQuery = new strSelect("
	SELECT sted_expired_date, /*sted_wh_location,*/ ".ZKP_SQL."_getRemainMonth(sted_expired_date) AS expired_date, 
		   sum(sted_qty) AS remain_month 
	FROM ".ZKP_SQL."_tb_stock_ed");
$sqlQuery->whereCaluse = "sted_qty!=0 AND it_code='$_code'";
