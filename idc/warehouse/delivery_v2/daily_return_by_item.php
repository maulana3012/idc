...
//Global
$left_loc 	  = "daily_return_by_item.php";
...
<table width="100%" class="table_layout">
	<tr>
		<td rowspan="2" width="90%" valign="top"><strong class="title">[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] RETURN SUMMARY by item</strong></td>
		<td> ORDER BY </td>
		<td>PUSAT</td>
		<td> CATEGORY </td>
	</tr>
...
<table width="100%" class="table_box">
	<tr>
		<td align="right">
			<a href="./daily_return_by_group.php?<?php echo getQueryString()?>">View By Group</a>
		</td>
	</tr>
</table><br />
<?php require_once APP_DIR . "_include/warehouse/report/delivery_v2/rpt_daily_return_by_item.php" ?>
<script language="javascript1.2" type="text/javascript">
	...
	setSelect(f.cboDateBy, "<?php echo isset($_GET['cboDateBy']) ? $_GET['cboDateBy'] : "all"?>");	
