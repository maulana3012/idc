...
function seeDetail() {
	...
	window.location.href = 'history_stock.php?_code=' + code + '&cboLocation=' + loc;
}
...
<script language="javascript1.2" type="text/javascript">
	...
	function goPageLocation() {
		var f = window.document.frmSearch;
		window.location.href = "history_stock.php?_code="+trim(f._code.value)+"&cboLocation="+f.cboLocation.value+"&cboTypeActivity="+f.cboTypeActivity.value+
