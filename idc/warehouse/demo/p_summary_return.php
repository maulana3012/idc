...
<table class="table_layout" width="100%">
	<tr height="35px">
		<td style="font-size:15px;font-weight:bold">[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] RETURN DEMO SUMMARY</td>
	</tr>
	<tr>
