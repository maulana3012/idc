  ...
  <tr>
    <td style="padding:0 3 3 3">
        ...
        <tr>
          	...
          	<!--START: BODY-->
			<h4>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] RETURN DEMO SUMMARY by item</h4>
<?php
...
<?php require_once APP_DIR . "_include/warehouse/report/demo/rpt_daily_return_demo_by_item.php" ?>
