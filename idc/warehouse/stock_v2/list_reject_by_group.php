...
//GLOBAL
$left_loc	= "list_reject_by_group.php";
?>
<html>
<head>
...
?>
<h4>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] REJECT SUMMARY by group</h4>
...
<tr>
<td align="right">
	<a href="./list_reject_by_item.php?<?php echo getQueryString()?>">View By Item</a>
</td>
</tr>
</table>
<?php require_once APP_DIR . "_include/{$currentDept}/report/{$moduleDept}/rpt_list_reject_by_group.php" ?>
