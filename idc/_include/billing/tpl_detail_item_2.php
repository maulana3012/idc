...
<?php while($items =& fetchRow($cusitem_res)) { ?>
		<tr id="<?php echo trim($items[0])?>">
			...
			<td><input type="text" name="_cus_it_unit_price[]" value="<?php echo number_format((double)$items[5])?>" class="reqn" style="width:100%" onBlur="updateAmount()" onKeyUp="formatNumber(this,'dot')"></td>
