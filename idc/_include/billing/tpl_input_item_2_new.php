...
<table width="100%" class="table_box">
	...
	<tr>
		...
		<th width="5%"><input name="_disc" type="text" class="reqn" style="width:100%" value="0" onBlur="updateAmount()"></th>
...
function fillItem(){
	...
	wSearchItem = window.open('./p_list_item.php?_cus_code=<?php echo $_cus_to;?>','wSearchItem',
...
function updateAmount(){
	...
	var numItem		= document.querySelectorAll('#rowPosition tr').length;
	var numInput	= 9;	/////
	var idx_price	= 37;	/////
