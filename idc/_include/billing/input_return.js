function fillCustomer(target) {
	...
	var win = window.open(
		'../../_include/billing/p_list_cus_code.php?_dept='+dept+'&_check_code='+ keyword,
		target,
...
function seedetailreturn() {
	...
	winforPrint.document.location.href = "<?php echo HTTP_DIR . "$currentDept/$moduleDept/revise_billing.php?_code=$_bill_code" ?>";
}
<?php } ?>
*/