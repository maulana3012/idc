...
<table class="table_box" width="100%">
	...
	<tr>
		...
		<td>
			<input type="radio" name="_bank" value="MANDIRI" onCLick="bankDesc(this.value)" id="mandiri" disabled <?php echo ($column['bill_payment_bank'] == 'MANDIRI') ? 'checked' : '' ?>><label for="mandiri">Mandiri</label>
		</td>
...
<table width="100%" class="table_box">
	...
	<tr>
		...
		<td colspan="3">
			...
			<input type="radio" name="_signature_pajak_by" value="B" id="signB" <?php echo ($column['bill_signature_pajak_by']=='B'?" checked":"") ?>><label for="signB">Hee Bae Kim</label>
		</td>
	</tr>
	<?php } else if(ZKP_SQL == 'MED' && $column["bill_vat"] > 0) { ?>
	<tr>
		<th>SIGN PAJAK BY</th>
		<td colspan="3">
			...
			<input type="radio" name="_signature_pajak_by" value="B" id="signB" <?php echo ($column['bill_signature_pajak_by']=='B'?" checked":"") ?>><label for="signB">Tia Setiawati</label>
		</td>
	</tr>
    <?php } ?>
	...
	<?php if ($S->getValue("ma_account") == 'rosalia' || $S->getValue("ma_account") == 'nyla') { ?>
	<tr>
		<th>NOTES</th>
		<td colspan="3"><textarea name="_note" style="width:100%" rows="5"><?php echo $column['bill_remark_notes'] ?></textarea></td>
	</tr>
	<?php } else { ?>
		<input type="hidden" name="_note" value="<?php echo $column['bill_remark_notes'] ?>">
	<?php } ?>
</table>