...
if($_code == 'IO-06964A-E18') {
	$row	= array(21, 0, $row_cus, 0, 0); //0. default limit, 1. adding row, 2.jumlah item, 3.jumlah total baris, 4.-
} else {
...
//FAKTUR PAJAK ===================================================================================================
$bill_date = strtotime($_inv_date);
$mydate = strtotime('01-Jul-2015');
