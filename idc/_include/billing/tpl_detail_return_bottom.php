...
<table class="table_box" width="100%">
	...
	<tr>
		...
		<?php if(ZKP_SQL == 'IDC') { ?>
		<td>
			<input type="radio" name="_bank" value="BCA1" id="bca1" <?php echo ($column['turn_payment_bank'] == 'BCA1') ? 'checked' : '' ?> onCLick="bankDesc(this.value)" disabled><label for="bca1">BCA 1</label><br />
			<input type="radio" name="_bank" value="BCA2" id="bca2" <?php echo ($column['turn_payment_bank'] == 'BCA2') ? 'checked' : '' ?> onCLick="bankDesc(this.value)" disabled><label for="bca2">BCA 2</label><br />
			<input type="radio" name="_bank" value="MANDIRI" id="mandiri" <?php echo ($column['turn_payment_bank'] == 'MANDIRI') ? 'checked' : '' ?> onCLick="bankDesc(this.value)" disabled><label for="mandiri">Mandiri</label><br />
		</td>
		<td>
			<input type="radio" name="_bank" value="BII1" id="bii1" <?php echo ($column['turn_payment_bank'] == 'BII1') ? 'checked' : '' ?> onCLick="bankDesc(this.value)" disabled><label for="bii1">BII 1</label><br />
			<input type="radio" name="_bank" value="BII2" id="bii2" <?php echo ($column['turn_payment_bank'] == 'BII2') ? 'checked' : '' ?> onCLick="bankDesc(this.value)" disabled><label for="bii2">BII 2</label><br />
			<input type="radio" name="_bank" value="DANAMON" id="danamon" <?php echo ($column['turn_payment_bank'] == 'DANAMON') ? 'checked' : '' ?> onCLick="bankDesc(this.value)" disabled><label for="danamon">Danamon</label>
		</td>
		<?php } else if(ZKP_SQL == 'MED') { ?>
		<td colspan="2">
			<input type="radio" name="_bank" value="DANAMON2" onCLick="bankDesc(this.value)" id="danamon2" <?php echo ($column['turn_payment_bank'] == 'DANAMON2') ? 'checked' : '' ?> onCLick="bankDesc(this.value)" disabled><label for="danamon2">DANAMON</label><br />
			<input type="radio" name="_bank" value="BII3" onCLick="bankDesc(this.value)" id="bii3" <?php echo ($column['turn_payment_bank'] == 'BII1') ? 'BII3' : '' ?> onCLick="bankDesc(this.value)" disabled><label for="bii3">BII</label><br />
		</td>
		<?php } ?>
		<td colspan="2">
...
<table width="100%" class="table_box">
	<tr>
		...
		<td><input type="text" name="_signature_pajak_by" class="fmt" maxlength="32" value="<?php echo $column['turn_signature_pajak_by'] ?>"></td>
	</tr>
	<tr>
		<th>REMARK</th>
		<td colspan="3"><textarea name="_remark" rows="4" style="width:100%"><?php echo $column['turn_remark'] ?></textarea></td>
	</tr>
</table>