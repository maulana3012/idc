...
"SELECT
  ...
  '../packing_list/detail_confirm_pl.php?_ver=v1&_code='||a.pl_idx||'&_inpl_idx='||a.inpl_idx AS  go_inpl_page
FROM
...
SELECT
  ...
  b.init_qty, 
  '../packing_list/revise_pl.php?_code='||a.pl_idx AS go_pl_page,
  '../packing_list/detail_confirm_pl.php?_ver=v2&_code='||a.pl_idx||'&_inpl_idx='||a.inpl_idx AS  go_inpl_page
FROM
  ".ZKP_SQL."_tb_in_pl_v2 AS a
  JOIN ".ZKP_SQL."_tb_in_pl_item_v2 AS b USING(inpl_idx)
  JOIN ".ZKP_SQL."_tb_item AS c USING(it_code)
WHERE a.po_code = '$_code'
ORDER BY inpl_idx, inpl_checked_date, it_code 
";
echo "<pre>";
//echo $sql_pl;
echo "</pre>";
...
"SELECT
  ...
  END AS inpl_has_ed,
  '../packing_list/detail_confirm_pl.php?_ver=v1&_code='||a.pl_idx||'&_inpl_idx='||a.inpl_idx AS  go_page
FROM
  ".ZKP_SQL."_tb_in_pl AS a
  JOIN ".ZKP_SQL."_tb_in_pl_item AS b USING(inpl_idx)
  JOIN ".ZKP_SQL."_tb_item AS c USING(it_code)
...
SELECT
  ...
  END AS inpl_has_ed,
  '../packing_list/detail_confirm_pl.php?_ver=v2&_code='||a.pl_idx||'&_inpl_idx='||a.inpl_idx AS  go_page
FROM
  ".ZKP_SQL."_tb_in_pl_v2 AS a
  JOIN ".ZKP_SQL."_tb_in_pl_item_v2 AS b USING(inpl_idx)
  JOIN ".ZKP_SQL."_tb_item AS c USING(it_code)
