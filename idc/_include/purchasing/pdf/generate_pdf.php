...
if(ZKP_SQL == 'IDC') {
	if($_layout_type == 1) 		$pdf_template = "idc_po_form_1.pdf";
	else if($_layout_type == 2) $pdf_template = "idc_po_form_2.pdf";
	else if($_layout_type == 3) $pdf_template = "idc_po_form_3.pdf";
	else if($_layout_type == 4) $pdf_template = "idc_po_form_4.pdf";
} else if(ZKP_SQL == 'MED') {
	if($_layout_type == 1) 		$pdf_template = "med_po_form_1.pdf";
	else if($_layout_type == 2) $pdf_template = "med_po_form_2.pdf";
	else if($_layout_type == 3) $pdf_template = "med_po_form_3.pdf";
	else if($_layout_type == 4) $pdf_template = "med_po_form_4.pdf";
}
//Supplier info
