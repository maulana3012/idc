...
SELECT
  ...
  'PL-v1-'||inpl.inpl_idx AS inpl_idx,
  ...
  END AS pl_type,
 'revise_pl.php?_ver=v1&_code='||pl.pl_idx AS go_page_pl,
 'detail_confirm_pl.php?_ver=v1&_code='||pl.pl_idx||'&_inpl_idx='||inpl.inpl_idx AS go_page_inc
FROM
...
SELECT
  ...
  sp.sp_code AS sp_code,
  sp.sp_full_name AS sp_name,
  'PL-v2-'||inpl.inpl_idx AS inpl_idx,
  inpl.inpl_checked_date AS inpl_checked_date,
  to_char(inpl.inpl_checked_date, 'dd-Mon-YY') AS checked_date,
  icat.icat_pidx AS icat_pidx,
  icat.icat_midx AS icat_midx,
  ...
  CASE
 	...
 	WHEN pl.pl_type = 2 THEN 'NON'
  END AS pl_type,
 'revise_pl.php?_ver=v2&_code='||pl.pl_idx AS go_page_pl,
 'detail_confirm_pl.php?_ver=v2&_code='||pl.pl_idx||'&_inpl_idx='||inpl.inpl_idx AS go_page_inc
FROM
  ".ZKP_SQL."_tb_supplier AS sp
  JOIN ".ZKP_SQL."_tb_pl AS pl ON pl.pl_sp_code = sp.sp_code
...
SELECT
  ...
  sp.sp_code AS sp_code,
  sp.sp_full_name AS sp_name,
  'CL-v1-'||incl.incl_idx AS inpl_idx,
  ...
  init.init_qty AS it_qty,
  'NON' AS pl_type,
  'revise_claim.php?_ver=v1&_code='||incl.incl_idx AS go_page_pl,
  'detail_confirm_claim.php?_ver=v1&_code='||cl.cl_idx||'&_incl_idx='||incl.incl_idx AS go_page_inc
FROM
  ".ZKP_SQL."_tb_supplier AS sp
...
SELECT
  ...
  sp.sp_code AS sp_code,
  sp.sp_full_name AS sp_name,
  'CL-v2-'||incl.incl_idx AS inpl_idx,
  incl.incl_checked_date AS inpl_checked_date,
  to_char(incl.incl_checked_date, 'dd-Mon-YY') AS checked_date,
  icat.icat_pidx AS icat_pidx,
  icat.icat_midx AS icat_midx,
  ...
  init.init_qty AS it_qty,
  'NON' AS pl_type,
  'revise_claim.php?_ver=v2&_code='||incl.incl_idx AS go_page_pl,
  'detail_confirm_claim.php?_ver=v2&_code='||cl.cl_idx||'&_incl_idx='||incl.incl_idx AS go_page_inc
FROM
  ".ZKP_SQL."_tb_supplier AS sp
  JOIN ".ZKP_SQL."_tb_claim AS cl ON cl.cl_sp_code = sp.sp_code
