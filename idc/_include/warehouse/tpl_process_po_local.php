...
if(ckperm(ZKP_UPDATE, HTTP_DIR . "$currentDept/$moduleDept/index.php", 'update_PO')) {
	...
	$_lastupdated_by_account = $S->getValue("ma_account");
	$_revision_time = (int) $_POST['_revesion_time'] + 1;
...
//UNCONFIRM PO ========================================================================================================
if(ckperm(ZKP_UPDATE, HTTP_DIR . "$currentDept/$moduleDept/index.php", 'unconfirmed')) {

	$_code	= $_POST['_code'];
	$result = executeSP(ZKP_SQL."_unconfirmedPO", "$\${$_code}$\$", "$\$PO Local$\$");
