...
SELECT
 ...
 END AS pl_type,
 'confirm_pl.php?_ver=v1&_code='||pl.pl_idx AS go_cfm_page,
 'detail_confirm_pl.php?_ver=v1&_code='||pl.pl_idx||'&_inpl_idx='||inpl.inpl_idx AS go_page
FROM
...
SELECT
 ...
 CASE
 	...
 	WHEN pl.pl_type = 2 THEN 'NON'
 END AS pl_type,
 'confirm_pl.php?_ver=v2&_code='||pl.pl_idx AS go_cfm_page,
 'detail_confirm_pl.php?_ver=v2&_code='||pl.pl_idx||'&_inpl_idx='||inpl.inpl_idx AS go_page
FROM
 ".ZKP_SQL."_tb_supplier AS sp
 JOIN ".ZKP_SQL."_tb_pl AS pl ON pl.pl_sp_code = sp.sp_code
...
SELECT
 ...
 init.init_qty AS it_qty,
 'NON' AS pl_type,
 'confirm_claim.php?_ver=v1&_code='||cl.cl_idx AS go_cfm_page,
 'detail_confirm_claim.php?_ver=v1&_code='||cl.cl_idx||'&_incl_idx='||incl.incl_idx AS go_page
FROM
 ".ZKP_SQL."_tb_supplier AS sp
...
SELECT
 ...
 init.init_qty AS it_qty,
 'NON' AS pl_type,
 'confirm_claim.php?_ver=v2&_code='||cl.cl_idx AS go_cfm_page,
 'detail_confirm_claim.php?_ver=v2&_code='||cl.cl_idx||'&_incl_idx='||incl.incl_idx AS go_page
FROM
 ".ZKP_SQL."_tb_supplier AS sp
 JOIN ".ZKP_SQL."_tb_claim AS cl ON cl.cl_sp_code = sp.sp_code
...
SELECT
 ...
 END AS pl_type,
 'confirm_pl_local.php?_ver=v1&_code=' || po_code || '&_pl_no=' || pl_no AS go_cfm_page,
 'detail_confirm_pl_local.php?_ver=v1&_inlc_idx=' || inlc_idx AS go_page
FROM
...
SELECT
 ...
 CASE
 	...
 	WHEN po.po_type = 2 THEN 'NON'
 END AS pl_type,
 'confirm_pl_local.php?_ver=v2&_code=' || po_code || '&_pl_no=' || pl_no AS go_cfm_page,
 'detail_confirm_pl_local.php?_ver=v2&_inlc_idx=' || inlc_idx AS go_page
FROM
 ".ZKP_SQL."_tb_supplier_local AS sp
 JOIN ".ZKP_SQL."_tb_po_local AS po USING(sp_code)
 JOIN ".ZKP_SQL."_tb_pl_local AS pl USING(po_code)
...
END;
	...
	foreach($group1 as $total2 => $group2) {
		...
		print "<tr>\n";
		cell("<b>TOTAL $invoice</b>", ' colspan="3" align="right" style="color:darkblue"');
