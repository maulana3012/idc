...
SELECT
 ...
 ".ZKP_SQL."_lastArrived('PL', 'PL', 'Date', pl.pl_idx::varchar, plit.it_code) AS last_arrived_date,
...
SELECT
 ...
 ".ZKP_SQL."_lastArrived('PL', 'Claim', 'Date', cl.cl_idx::varchar, clit.it_code) AS last_arrived_date,
...
SELECT
 ...
 ".ZKP_SQL."_lastArrived('PL', 'Local', 'Date', po_code|| '-' ||pl_no, plit.it_code) AS last_arrived_date,
...
$sql = "$sql_pl UNION $sql_claim UNION $sql_local ORDER BY sp_name, invoice_date, idx, it_code";
...
END;
	...
	foreach($group1 as $total2 => $group2) {
		...
		print "<tr>\n";
		cell("<b>TOTAL $invoice</b>", ' colspan="1" align="right" style="color:darkblue"');
