<table width="100%" class="table_nn">
	<tr>
		<td height="35"><img src="../../_images/icon/star.gif">&nbsp;&nbsp;<strong>WAREHOUSE INFORMATION</strong> &nbsp; <i>( <a href="revise_order_2.php?_code=<?php echo $_code ?>">Revised item</a> )</i></td>		<td align="right">
