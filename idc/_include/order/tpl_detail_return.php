    ...
    <tr>
		...
		<td>
    		<table width="100%" class="table_nn">
				...
				while($items =& fetchRowAssoc($reor_res)) {
				?> 
				<tr>
					<td><?php echo $items['it_code']?></td>
					<td><?php echo $items['it_model_no']?></td>
					<td><?php echo $items['it_desc']?></td>
					<td align="right"><?php echo number_format((double)$items['roit_unit_price'])?></td>
					<td align="right"><?php echo number_format((double)$items['roit_qty'])?></td>
					<td align="right"><?php echo number_format((double)$items['roit_unit_price']*$items['roit_qty'])?></td>
