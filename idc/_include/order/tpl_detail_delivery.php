    	...
    	<td>
			...
			<table width="100%" class="table_box">
				...
				<tr>
					...
					<td width="10%">DELIVERY BY</td>
					<td width="2%">:</td>
					<td><input type="text" class="fmt" size="25" name="_delivery_by_whom"></td>
					<td width="10%">RECEIVED BY</td>
					<td width="2%">:</td>
					<td><input type="text" class="fmt" size="25" name="_received_by_whom"></td>
					<td align="right">
				...
				<?php } else { 
				$sql = "SELECT * FROM ".ZKP_SQL."_tb_delivery WHERE ord_code = '$_code'";
				$result =& query($sql);
				$deli =& fetchRowAssoc($result);
				?>
				<tr>
					<td width="30%">DATE &nbsp; : &nbsp; <?php echo date('d-M-Y', strtotime($deli['deli_date']))?></td>
					<td width="30%">DELIVERY BY &nbsp; : &nbsp; <?php echo $deli['deli_by'] ?></td>
					<td width="30%">RECEIVED BY &nbsp; : &nbsp; <?php echo $deli['deli_received_by'] ?></td>
					<td align="right">
