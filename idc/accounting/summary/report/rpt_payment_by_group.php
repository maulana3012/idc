...
if(ZKP_FUNCTION == 'ALL') {
	if($_order_by != 'all'){
		...
		if($cboFilter[1][ZKP_URL][0][0] == '2') $tmp_service[]	= "sv_code is null";
	}
} else {
	$tmp_billing1[]	= "bill_ordered_by = ".$cboFilter[1][ZKP_URL][0][0] . " AND ".ZKP_SQL."_isValidShowInvoice('".ZKP_URL."', bill_code,'billing')";
	$tmp_billing2[]	= "bill_ordered_by = ".$cboFilter[1][ZKP_URL][0][0] . " AND ".ZKP_SQL."_isValidShowInvoice('".ZKP_URL."', bill_code,'billing')";
	if($cboFilter[1][ZKP_URL][0][0] == '2') $tmp_service[]	= "sv_code is null";
}
...
END;
	...
	foreach ($group1 as $total2 => $group2) {
		...
		foreach ($group2 as $total3 => $group3) {
			...
			cell(number_format($rd[$rdIdx][7]), ' align="right" valign="top" rowspan="'.$rowSpan.'"');	//amount
			cell(number_format($rd[$rdIdx][8]), ' align="right" valign="top" rowspan="'.$rowSpan.'"');	// freight
			cell(number_format($rd[$rdIdx][9]), ' align="right" valign="top" rowspan="'.$rowSpan.'"');	//vat
			cell(number_format($rd[$rdIdx][10]), ' align="right" valign="top" rowspan="'.$rowSpan.'"');	//amount +vat+freight
			...
			foreach ($group3 as $group4) {
				...
				cell(number_format($rd[$rdIdx][15]), ' style="'.$display_css[$rd[$rdIdx][19]].'" align="right"'); //Amount paid
				cell("&nbsp;");									//Remain billing
			...
			cell(number_format($invoice[0]), ' align="right" style="color:blue"');	//Amount
			cell(number_format($invoice[1]), ' align="right" style="color:blue"');	//Delivery charge
			cell(number_format($invoice[2]), ' align="right" style="color:blue"');	//Vat
			cell(number_format($invoice[3]), ' align="right" style="color:blue"');	//Grand total
			cell("&nbsp");	//Payment date
			cell("&nbsp");	//Payment method
			cell("&nbsp");	//Payment bank
			cell(number_format($invoice[4]), ' align="right" style="color:blue"');	//Payment amount
			cell(number_format($invoice[5]), ' align="right" style="color:blue"');	//Billing remain
			cell("&nbsp");
		...
		cell(number_format($customer_summary[0]), ' align="right" style="color:brown"');
		cell(number_format($customer_summary[1]), ' align="right" style="color:brown"');
		cell(number_format($customer_summary[2]), ' align="right" style="color:brown"');
		cell(number_format($customer_summary[3]), ' align="right" style="color:brown"');
		cell("&nbsp;");
		cell("&nbsp;");
		cell("&nbsp;");
		cell(number_format($customer_summary[4]), ' align="right" style="color:brown"');
		cell(number_format($customer_summary[5]), ' align="right" style="color:brown"');
		cell("&nbsp");
		cell(number_format($customer_summary[6]), ' align="right" style="color:brown"');
		print "</tr>\n";
	...
	cell(number_format($group_summary[0]), ' align="right" style="color:brown; background-color:lightyellow"');
	cell(number_format($group_summary[1]), ' align="right" style="color:brown; background-color:lightyellow"');
	cell(number_format($group_summary[2]), ' align="right" style="color:brown; background-color:lightyellow"');
	cell(number_format($group_summary[3]), ' align="right" style="color:brown; background-color:lightyellow"');
	cell("&nbsp", ' style="color:brown; background-color:lightyellow"');
	cell("&nbsp", ' style="color:brown; background-color:lightyellow"');
	cell("&nbsp", ' style="color:brown; background-color:lightyellow"');
	cell(number_format($group_summary[4]), ' align="right" style="color:brown; background-color:lightyellow"');
	cell(number_format($group_summary[5]), ' align="right" style="color:brown; background-color:lightyellow"');
	cell("&nbsp", ' style="color:brown; background-color:lightyellow"');
	cell(number_format($group_summary[6]), ' align="right" style="color:brown; background-color:lightyellow"');
	print "</tr>\n";
	print "</table><br>\n";
