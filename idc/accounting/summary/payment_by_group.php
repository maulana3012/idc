...
<body topmargin="0" leftmargin="0" onload="fillOption('bank',0)">
...
?>
<h4>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] PAYMENT SUMMARY by group </h4>
...
<script language="javascript1.2" type="text/javascript">
	...
	setSelect(f.cboFilterVat, "<?php echo isset($_GET['cboFilterVat']) ? $_GET['cboFilterVat'] : $cboFilter[2][ZKP_URL][0][0] ?>");
