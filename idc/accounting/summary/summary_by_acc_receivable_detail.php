...
//GLOBAL
$left_loc = "summary_by_acc_receivable.php";

if(isset($_GET['code']) && $_GET['code'] != '') {
	 $code = $_GET['code'];
	 $name = $_GET['name'];
} else goPage("summary_by_acc_receivable.php");
?>
<html>
<head>
...
?>
<h3>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] SUMMARY PAYMENT by department</h3>
...
<table width="100%" class="table_layout">
	<tr>
		<td width="50%" rowspan="2">
            <h4>Customer : <?php echo $name ?></h4>
        </td>
		<td valign="bottom"><div class="divOrderBy"> ORDER BY </div></td>
		<td valign="bottom"> VAT </td>
		<td valign="bottom"> DEPT </td>
		<td valign="bottom"> INVOICE PERIOD </td>
	</tr>
	<tr>
...
<?php include "./report/rpt_summary_by_acc_receivable_detail.php"; ?>
<script language="javascript1.2" type="text/javascript">
	...
	f.cboFilterDept.onchange = f.cboFilterVat.onchange;
