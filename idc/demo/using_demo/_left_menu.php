...
$cat = array("Boooking Demo", "Outgoing Demo", "Return Demo", "Using Balance");

$item0[] = "daily_booking_demo_by_item.php::By Item";
$item0[] = "daily_booking_demo_by_reference.php::By Reference";
...
$item3[] = "daily_using_balance_by_item.php::By Item";
$item3[] = "daily_using_balance_by_reference.php::By Reference";
//------------------------------------------------------------------
