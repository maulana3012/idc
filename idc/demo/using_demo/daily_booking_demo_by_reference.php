...
<table width="100%" class="table_layout">
	<tr>
		<td width="85%" rowspan="2"><h4>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] BOOKING DEMO SUMMARY by reference</h4></td>
		<td> CATEGORY </td>
	</tr>
	<tr>
		<td>	
...
<table width="100%" class="table_box">
	<tr>
		<td align="right">
			<a href="./daily_booking_demo_by_item.php?<?php echo getQueryString()?>">View By Item</a>
		</td>
	</tr>
</table>
<?php require_once APP_DIR . "_include/demo/report/rpt_daily_booking_demo_by_reference.php" ?>
...
?>
	...
	function summarizeRequest() {
		...
		var win = window.open(
			'./p_summary_booking.php?_code='+ keyword,
			'',
