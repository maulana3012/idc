...
<table width="100%" class="table_layout">
	<tr>
		<td width="85%" rowspan="2"><h4>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] REQUEST BALANCE SUMMARY by reference</h4></td>
		<td> CATEGORY </td>
	</tr>
	<tr>
		<td>	
...
<tr>
<td align="right">
	<a href="./daily_using_balance_by_data.php?<?php echo getQueryString()?>">Export Data</a> &nbsp; | &nbsp;
