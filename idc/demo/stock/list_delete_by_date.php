...
//Global
$left_loc 	= "list_delete_by_date.php";
?>
<html>
<head>
...
<table width="100%" class="table_box">
	<tr>
		<td align="right">
			<a href="./list_delete_by_item.php?<?php echo getQueryString()?>">View By Item</a>
		</td>
	</tr>
</table>
<?php require_once APP_DIR . "_include/demo/report/rpt_list_delete_by_date.php" ?>
