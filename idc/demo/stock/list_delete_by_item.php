...
//Global
$left_loc 	= "list_delete_by_item.php";
?>
<html>
<head>
...
?>
<h4>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] DELETED DEMO SUMMARY by item</h4>
...
<table width="100%" class="table_box">
	<tr>
		<td align="right">
			<a href="./list_delete_by_date.php?<?php echo getQueryString()?>">View By Date</a>
		</td>
	</tr>
</table>
<?php require_once APP_DIR . "_include/demo/report/rpt_list_delete_by_item.php" ?>
