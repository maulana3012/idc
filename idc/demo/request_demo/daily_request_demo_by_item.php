...
//Global
$left_loc 	  = "daily_request_demo_by_item.php";
...
<script src="../../_script/SpryTabbedPanels.js" type="text/javascript"></script><script language="text/javascript" type="text/javascript" src="../../_script/js_category.php"></script>
...
<table width="100%" class="table_layout">
	<tr>
		<td width="85%" rowspan="2"><h4>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] INCOMING DEMO STOCK SUMMARY by item</h4></td>
		<td> CATEGORY </td>
	</tr>
	<tr>
		<td>	
	...
	<tr>
		...
		<td>
			<select name="cboStatus">
				...
				<option value="1">Cfm Warehouse</option>
				<option value="2">Cfm WH &gt; Mkt</option>
			</select>
		</td>
		<td valign="middle">
...
<table width="100%" class="table_box">
	<tr>
		<td align="right">
			<a href="./daily_request_demo_by_reference.php?<?php echo getQueryString()?>">View By Reference</a>
		</td>
	</tr>
</table>
<?php require_once APP_DIR . "_include/demo/report/rpt_daily_request_by_item.php" ?>
...
?>
	...
	f.cboSource.onchange = f.cboStatus.onchange;
