...
<table width="100%" class="table_layout">
	<tr>
		<td width="90%" rowspan="2"><h3>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] DT SUMMARY by item</h3></td>
...
<?php require_once APP_DIR . "_include/other/report/rpt_dt_summary_by_item.php" ?>
