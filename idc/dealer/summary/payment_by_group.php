...
$cboSearchType 	= isset($_GET['cboSearchType'])? $_GET['cboSearchType'] : "byPayment";
...
<table width="100%" class="table_layout">
	<tr>
		<td width="80%" rowspan="2"><h3>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] PAYMENT SUMMARY by group</h3></td>
