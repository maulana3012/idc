...
?>
	<tr id="<?php echo trim($column['it_code'])?>">
		...
		<td width="11%" align="right"><?php echo number_format($column['real_stock'],1);?></td>
		<td width="11%" align="right"><?php echo number_format($column['est_stock'],1);?></td>
		<td width="11%" align="right"><?php echo number_format($column['book_qty'],1);?></td>
	</tr>
<?php } ?>	
  </tbody>
</table>
