...
<table width="100%" class="table_layout">
	<tr>
		<td width="90%" rowspan="2"><h3>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] LIST WARRANTY CARD by Item</h3></td>
		<td> PRODUCT </td>
	</tr>
	<tr>
		<td>
...
<div align="right">
	<a href="./summary_warranty_by_data.php?<?php echo getQueryString()?>">Export Data</a> &nbsp;
</div><br />
</form>
...
?>
	...
	setSelect(f.cboDateBy, "<?php echo isset($_GET['cboDateBy']) ? $_GET['cboDateBy'] : "purchase"?>");
