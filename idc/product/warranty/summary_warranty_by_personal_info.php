...
if($_date == 'purchase')
{
	if ($some_date != "") {
		...
		$get[] = "cboDateBy=$_date&period_from=&period_to=&some_date=$some_date";
	} else {
		$tmp[] = "wr_purchase_date BETWEEN DATE '$period_from' AND DATE '$period_to'";
		$get[] = "cboDateBy=$_date&period_from=$period_from&period_to=$period_to&some_date=";
	}
} else if($_date == 'input')
{
	if ($some_date != "") {
...
<table width="100%" class="table_layout">
	...
	<tr>
		...
		<td>Total <?php echo $numRow ?> row(s)</td>
</table><br />
</form>
