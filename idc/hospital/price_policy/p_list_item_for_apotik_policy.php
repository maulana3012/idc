...
//ckperm(ZKP_SELECT, "../price_policy/index.php");

//DEFAULT PROCESS
$sqlQuery = new strSelect("SELECT it_code, it_model_no, it_type, it_desc, ".ZKP_SQL."_getUserPrice(it_code, CURRENT_DATE) AS user_price FROM ".ZKP_SQL."_tb_item");
$strGet = "";
...
function createNewItem(idx) {
	window.opener.createItem(it[idx]);
...
<small>* Printed for price policy item list</small>
</strong>
<hr>
...
<table width="100%" class="table_box">
	<tr>
		...
		<th width="15%">
			...
			<a href="javascript:document.location.href='p_list_item_for_apotik_policy.php'"><img src="../../_images/icon/list_mini.gif" alt="Show all item"></a>&nbsp;
		</th>
	</tr>
</table><br />
<script language="javascript" type="text/javascript">
...
<div style="height:410; overflow-y:scroll">
...
?>
	<tr>
		...
		<td width="7%"><a href="javascript:createNewItem('<?php echo addslashes(html_entity_decode($column['it_code'], ENT_QUOTES));?>')"><?php echo $column['it_code']?></a></td>
		<td width="15%"><?php echo cut_string($column['it_model_no'], 10)?></td>
		<td><?php echo cut_string($column['it_desc'], 33)?></td>
		<td align="right" width="18%"><?php echo "Rp. ".number_format((double)$column['user_price'])?></td>
</tr>
<?php } ?>
</table>
</div>
