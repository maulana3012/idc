...
function fillField(idx) {
	...
	if (target == 'sales_log') {
		window.opener.document.frmSearch._cus_code.value = cus[idx][0];
		window.opener.document.frmSearch.some_date.value = '';
		window.opener.document.frmSearch.s_mode.value = 'period';
		...
		f._cus_to_responsible_by.value = cus[idx][3];
	} else {
		window.opener.document.frmInsert._cus_to.value=cus[idx][0];
	}
	window.close();
}
...
<table width="100%" class="table_box">
	<tr>
		...
		<th rowspan="2" width="15%">
			...
			<a href="javascript:document.location.href='p_list_cus_code.php?_cus_channel=002'"><img src="../../_images/icon/list_mini.gif" alt="see all"></a>
		</th>
	</tr>
	<tr>
