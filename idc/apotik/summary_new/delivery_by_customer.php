...
//GLOBAL
$left_loc	= "delivery_by_customer.php";
...
function fillCustomer(code) {
	...
	var win = window.open(
		'<?php echo HTTP_DIR . $currentDept . "/summary/" ?>p_list_cus_code.php?_check_code='+ code,
		'delivery',
...
<table width="100%" class="table_layout">
	<tr>
		<td width="90%" rowspan="2"><h3>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] DELIVERY SUMMARY by customer</h3></td>
		<td><div class="divOrderBy"> ORDER BY </div></td>
		<td><div class="divGroupBy"> MARKETING </div></td>
        <td> CATEGORY </td>
	</tr>
	<tr>
...
<?php require_once APP_DIR . "_include/billing/report/rpt_delivery_by_customer.php" ?>
