...
function checkform(o) {
	...
	if(o._type_bill.value == '1') {
		if (document.querySelectorAll('#itemWHPosition tr').length <= 0 || document.querySelectorAll('#itemCusPosition tr').length <= 0) {
			alert("You need to choose at least 1 item");
			return;
		}
	} else {
		if(o._type_bill.value == '2') {
			if (document.querySelectorAll('#rowPosition tr').length <= 0) {
				alert("You need to choose at least 1 item");
				return;
			}
		} else if(o._type_bill.value == '3') {
			if (document.querySelectorAll('#salesPosition tr').length<= 0 || document.querySelectorAll('#billPosition tr').length <= 0) {
				alert("You need to choose at least 1 item");
				return;
			}
		}
