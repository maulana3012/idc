...
<table width="100%" class="table_box">
	...
	<tr>
		...
		<td><input type="text" name="_representative" class="fmt"></td>
	</tr>
	<tr>
		<th>INTRODUCED BY</th>
		...
		<td>
			...
			<input type="radio" name="_tax_code_status" value="4">4 &nbsp;
			<input type="radio" name="_tax_code_status" value="7">7 <br>
			Attention : <br>
				<b>1</b> for general customer,<br>
				<b>2</b> for specific cust, ex Bendahara xxx, contact accounting for further info,<br> 
				<b>3</b> for spesific cust, ex : BUMN xxx, contact accounting for further info,<br> 
				<b>4</b> fro spesific cust, ex : DPP xxx, contact accounting for further info,<br> 
				<b>7</b> for non taxable customer.
		</td>
	</tr>
</table><br />
...
<table width="100%" class="table_box">
	<tr>
		...
		<td width="45%" rowspan="3"><textarea rows="4" style="width:100%" name="_address" class="req"></textarea></td>
