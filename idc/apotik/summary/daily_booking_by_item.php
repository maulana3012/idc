...
<table width="100%" class="table_layout">
	<tr>
		<td width="70%" rowspan="2"><strong class="title">[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] BOOKING SUMMARY by item<br /><br /></strong></td>
		<td>CATEGORY</td>
	</tr>
	<tr>
		<td>
...
<?php require_once APP_DIR . "_include/billing/report/rpt_daily_booking_detail_by_item.php" ?>
