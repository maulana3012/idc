...
$(document).ready(function(){
	...
	var ishideFilterSearch	= new Array("dealer","hospital","maketing", "pharmaceutical", "tender");

	if(in_array(url, ishideFilterOrderBy)) $(".divOrderBy").hide();
	if(in_array(dept, ishideFilterGroupBy)) $(".divGroupBy").hide();
	if(in_array(dept, ishideFilterSearch)) $(".divSearchBy").hide();
...
<h3>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] BILLING SUMMARY by group</h3>
<table width="100%" class="table_layout">
	<tr>
		...
		<td> MARKETING </td>
        <td><div class="divSearchBy">  SEARCH BY </div></td>
        <td> CATEGORY </td>
	</tr>
	<tr>
...
<div align="right">
	<a href="./daily_billing_by_data.php?<?php echo getQueryString()?>">Export Data</a> &nbsp; | &nbsp;
	<a href="./daily_billing_by_item.php?<?php echo getQueryString()?>">View By Item</a>
</div><br />
<?php require_once APP_DIR . "_include/billing/report/rpt_daily_billing_detail_by_group.php" ?>
