...
if($column['doc_accessible']=='f' && $page_permission) {
	...
	goPage(HTTP_DIR . "$currentDept/$moduleDept/detail_dr.php?_code=".urlencode($column['dr_code']));
}
...
<script language="javascript" type="text/javascript">
	...
	window.document.all.btnDelete.onclick = function() {
		if(confirm("Are you sure to delete billing?\n Deleting DR will delete booking items too")) {
			oForm.p_mode.value = 'delete_dr';
			oForm.submit();
		}
	}
