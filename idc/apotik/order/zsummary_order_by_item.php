...
//Global
$left_loc = "summary_order_by_item.php";
...
<table width="100%" class="table_layout">
	<tr>
		<td rowspan="2" width="80%"><h4>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] ORDER SUMMARY by item</h4></td>
...
<table width="100%" class="table_box">
	<tr>
		<td align="right">
			<a href="<?php echo HTTP_DIR . "$currentDept/$moduleDept/" ?>summary_order_by_group.php?<?php echo getQueryString()?>">View By Group</a>
		</td>
	</tr>
</table><br />
<?php require_once APP_DIR . "_include/order/report/rpt_daily_order_detail_by_item.php" ?>
<script language="javascript1.2" type="text/javascript">
	...
	f._cug_code.onchange = function() {
		...
		f.lastCategoryNo.value = <?php echo (isset($_GET['icat_1'])) ? $_GET['icat_1'] : 0 ?>;
		f.submit();
	}
