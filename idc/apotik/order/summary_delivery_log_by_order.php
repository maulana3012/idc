...
//GLOBAL
$left_loc = "summary_delivery_log_by_order.php";
...
<table width="100%" class="table_layout">
	<tr>
		<td width="90%" rowspan="2"><h3>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] DELIVERY LOG by order</h3></td>
...
<table width="100%" class="table_layout">
	...
	<tr>
		<td><input type="text" name="_cus_code" size="10" class="fmt" onClick="fillCustomer('')" value="<?php echo $_cus_code?>"></td>
		<td>
...
<?php require_once APP_DIR . "_include/order/report/rpt_summary_delivery_log_by_order.php" ?>
