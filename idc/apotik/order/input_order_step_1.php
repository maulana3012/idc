...
[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] NEW ORDER (STEP 1 / 2)<br />
</strong><br />
<form name='frmInsert' method='POST' action="./input_order_step_2.php">
<input type='hidden' name='p_mode' value='order_info'>
<input type='hidden' name='_dept' value='<?php echo $department ?>'>
<table width="100%" class="table_box">
	<tr>
		<td colspan="3"><strong class="info"><br />ORDER TYPE</strong></td>
	</tr>
	<tr height="40px">
...
<table width="100%" class="table_box">
	<tr>
		...
		<td>
		<select name="_type">
			<option value="OO">SALES</option>
			<option value="OK">KONSINYASI</option>
		</select></td>
