...
$top_menu['apotik'][] = array("price_policy", "list_group_policy.php", "<span style=\"color:#4B9142\">PRICE POLICY</span>");
$top_menu['apotik'][] = array("order", "input_order_step_1.php", "<span style=\"color:#4B9142\">ORDER & RETURN</span>");
$top_menu['apotik'][] = array("order", "summary_order_by_group.php", "<span style=\"color:#4B9142\">SUMMARY ORDER</span>");
$top_menu['apotik'][] = array("sales_rpt", "input_sales_report.php", "<span style=\"color:#4B9142\">SALES REPORT</span>");
$top_menu['apotik'][] = array("inventory", "inventory_summary_by_group.php", "<span style=\"color:#4B9142\">INVENTORY</span>");
...
$top_menu['dealer'][] = array("order", "input_order_step_1.php", "<span style=\"color:#4B9142\">ORDER & RETURN</span>");
$top_menu['dealer'][] = array("order", "summary_order_by_group.php", "<span style=\"color:#4B9142\">SUMMARY ORDER</span>");
$top_menu['dealer'][] = array("sales_rpt", "input_sales_report.php", "<span style=\"color:#4B9142\">SALES REPORT</span>");
$top_menu['dealer'][] = array("inventory", "inventory_summary_by_group.php", "<span style=\"color:#4B9142\">INVENTORY</span>");
...
$top_menu['hospital'][] = array("order", "input_order_step_1.php", "<span style=\"color:#4B9142\">ORDER & RETURN</span>");
$top_menu['hospital'][] = array("order", "summary_order_by_group.php", "<span style=\"color:#4B9142\">SUMMARY ORDER</span>");
$top_menu['hospital'][] = array("sales_rpt", "input_sales_report.php", "<span style=\"color:#4B9142\">SALES REPORT</span>");
$top_menu['hospital'][] = array("inventory", "inventory_summary_by_group.php", "<span style=\"color:#4B9142\">INVENTORY</span>");
...
$top_menu['marketing'][] = array("order", "input_order_step_1.php", "<span style=\"color:#4B9142\">ORDER & RETURN</span>");
$top_menu['marketing'][] = array("order", "summary_order_by_group.php", "<span style=\"color:#4B9142\">SUMMARY ORDER</span>");
$top_menu['marketing'][] = array("sales_rpt", "input_sales_report.php", "<span style=\"color:#4B9142\">SALES REPORT</span>");
$top_menu['marketing'][] = array("inventory", "inventory_summary_by_group.php", "<span style=\"color:#4B9142\">INVENTORY</span>");
...
$top_menu['marketing'][] = array("request_demo", "daily_request_demo_by_reference.php", "REQUEST DEMO");
...
$top_menu['pharmaceutical'][] = array("order", "input_order_step_1.php", "<span style=\"color:#4B9142\">ORDER & RETURN</span>");
$top_menu['pharmaceutical'][] = array("order", "summary_order_by_group.php", "<span style=\"color:#4B9142\">SUMMARY ORDER</span>");
$top_menu['pharmaceutical'][] = array("sales_rpt", "input_sales_report.php", "<span style=\"color:#4B9142\">SALES REPORT</span>");
$top_menu['pharmaceutical'][] = array("inventory", "inventory_summary_by_group.php", "<span style=\"color:#4B9142\">INVENTORY</span>");
...
$top_menu['sales'][] = array("item", "list_item.php", "ITEM");
$top_menu['sales'][] = array("customer", "list_customer.php", "CUSTOMER");
$top_menu['sales'][] = array("price_policy", "list_group_policy.php", "<span style=\"color:#4B9142\">PRICE POLICY</span>");
$top_menu['sales'][] = array("order", "input_order_step_1.php", "<span style=\"color:#4B9142\">ORDER & RETURN</span>");
$top_menu['sales'][] = array("order", "summary_order_by_group.php", "<span style=\"color:#4B9142\">SUMMARY ORDER</span>");
$top_menu['sales'][] = array("sales_rpt", "input_sales_report.php", "<span style=\"color:#4B9142\">SALES REPORT</span>");
$top_menu['sales'][] = array("inventory", "inventory_summary_by_group.php", "<span style=\"color:#4B9142\">INVENTORY</span>");
$top_menu['sales'][] = array("billing", "input_billing_step_1.php", "BILLING & RETURN");
$top_menu['sales'][] = array("summary", "daily_billing_by_group.php", "SUMMARY BILLING");
$top_menu['sales'][] = array("other", "input_do_step_1.php", "OTHERS");
$top_menu['sales'][] = array("stock", "list_stock.php", "STOCK");

//MODULE: TENDER
$top_menu['tender'][] = array("item", "list_item.php", "ITEM");
$top_menu['tender'][] = array("customer", "list_customer.php", "CUSTOMER");
$top_menu['tender'][] = array("order", "input_order_step_1.php", "<span style=\"color:#4B9142\">ORDER & RETURN</span>");
$top_menu['tender'][] = array("order", "summary_order_by_group.php", "<span style=\"color:#4B9142\">SUMMARY ORDER</span>");
$top_menu['tender'][] = array("sales_rpt", "input_sales_report.php", "<span style=\"color:#4B9142\">SALES REPORT</span>");
$top_menu['tender'][] = array("inventory", "inventory_summary_by_group.php", "<span style=\"color:#4B9142\">INVENTORY</span>");
...
//MODULE: SERVICE
$top_menu['customer_service'][] = array("item", "list_item.php", "ITEM");
$top_menu['customer_service'][] = array("customer", "list_customer.php", "CUSTOMER");
$top_menu['customer_service'][] = array("registration", "summary_reg_by_customer.php", "REGISTRATION");
$top_menu['customer_service'][] = array("service", "list_service.php", "SERVICE");

//MODULE: ACCOUNTING
$top_menu['accounting'][] = array("customer", "list_customer.php", "CUSTOMER");
$top_menu['accounting'][] = array("pajak", "list_fp_sent.php", "FAKTUR PAJAK");
...
$top_menu['purchasing'][] = array("setup_stock_v2", "list_initial_stock.php", "<img src=\"../../_images/icon/setting_mini.gif\"> SETUP STOCK");
$top_menu['purchasing'][] = array("stock_v2", "list_stock.php", "STOCK");
$top_menu['purchasing'][] = array("delivery_v2", "daily_booking_by_group.php", "BOOKING & OUTGOING");
$top_menu['purchasing'][] = array("delivery_v2", "daily_return_by_group.php", "RETURN");
...
$top_menu['warehouse'][] = array("stock_v2", "list_stock.php", "STOCK");
$top_menu['warehouse'][] = array("demo", "list_demo.php", "DEMO");
$top_menu['warehouse'][] = array("delivery_v2", "daily_booking_by_group.php", "BOOKING & OUTGOING");
$top_menu['warehouse'][] = array("delivery_v2", "daily_return_by_group.php", "RETURN");
...
$top_menu['letter']["summary"][]		= array("summary", "list_letter.php", "LETTER");
?>