...
if($isShowMessage != '') {
	...
	if($isShowMessage == "true") {
		...
		echo "\t<img src=\"../../_images/icon/check.gif\"> Sales data sucessfully added in apotik inventory\n";
		echo "</span><br /><br />\n";
	}
...
<table width="100%" class="table_box" cellspacing="1">
	<tr>
		...
		<th width="3%"><a href="javascript:fillCustomer(window.document.frmInsert._cus_to.value)"><img src="../../_images/icon/search_mini.gif" width="15px" align="middle" alt="Search customer"></a></th>
		<td width="5%"></td>
		<th width="12%">ATTN</th>
