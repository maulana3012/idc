...
//Global
$left_loc 	  = "daily_return_demo_by_item.php";
...
<table width="100%" class="table_layout">
	<tr>
		<td width="90%" rowspan="2"><h4>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] RETURN DEMO SUMMARY by item</h4></td>
...
<table width="100%" class="table_box">
	<tr>
		<td align="right">
			<a href="./daily_return_demo_by_reference.php?<?php echo getQueryString()?>">View By Reference</a>
		</td>
	</tr>
</table>
<?php require_once APP_DIR . "_include/request_demo/report/rpt_daily_return_demo_by_item.php" ?>
