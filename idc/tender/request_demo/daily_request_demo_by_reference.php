...
<table width="100%" class="table_layout">
	<tr>
		<td width="90%" rowspan="2"><h4>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] REQUEST DEMO SUMMARY by reference</h4></td>
...
<?php require_once APP_DIR . "_include/request_demo/report/rpt_daily_request_by_reference.php" ?>
...
?>
	...
	function summarizeRequest() {
		...
		var win = window.open(
			'./p_summary_booking_request.php?_code='+ keyword,
			'',
