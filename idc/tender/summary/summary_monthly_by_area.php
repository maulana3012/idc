...
//GLOBAL
$left_loc	= "summary_monthly_by_area.php";
...
<table width="100%" class="table_layout">
	<tr>
		<td width="90%" rowspan="2"><h3>[<font color="#446fbe"><?php echo strtoupper($currentDept) ?></font>] MONTHLY SALES SUMMARY by item</h3></td>
		<td> SHIP TO </td>
		<td> SHOW </td>
		...
		<td>
			<select name="cboFilterShow" onchange="submitSearch()">
...
<div align="right"><span class="comment"><i>*Based on Billing Summary</span></div>
<br />
</form>
<iframe id="rightFrame" src="i_summary_monthly_by_area.php?<?php echo getQueryString()?>" frameborder="0" width="100%" height="500px" name="iFrm"></iframe><br /><br />
<script language="javascript1.2" type="text/javascript">
	var f = window.document.frmSearch;
	var ts = <?php echo time() * 1000;?>;

	setSelect(f._cug_code, "<?php echo isset($_GET['_cug_code']) ? $_GET['_cug_code'] : ""?>");
	setSelect(f.cboFilterShow, "<?php echo isset($_GET['cboFilterShow']) ? $_GET['cboFilterShow'] : "qty"?>");
	setSelect(f.cboFilterOrder, "<?php echo isset($_GET['cboFilterOrder']) ? $_GET['cboFilterOrder'] : $cboFilter[1][ZKP_FUNCTION][0][0]?>");
